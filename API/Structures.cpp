...
struct GWAPI::Bag {							// total : 24 BYTEs
...
struct GWAPI::ModValue {						// total : 2 BYTEs
	BYTE Low;							// 0000
	BYTE High;							// 0001
};

struct GWAPI::Mod {							// total : 4 BYTEs
	ModValue Value;						// 0000
	WORD identifier;					// 0004
};

struct GWAPI::Item {							// total : 50 BYTEs
	DWORD ItemId;						// 0000
	DWORD AgentId;						// 0004
...
struct GWAPI::Skill {							// total : A0 BYTEs
	DWORD SkillId;						// 0000
...
struct GWAPI::Effect {							// total : 18 BYTEs
...
struct GWAPI::Buff {							// total : 10 BYTEs
...
struct GWAPI::Skillbar {						// total : BC BYTEs
