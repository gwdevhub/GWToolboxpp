...
namespace GW {
    ...
    namespace Packet {
        namespace StoC {
            ...
            template<> constexpr uint32_t Packet<TradeStart>::STATIC_HEADER = GAME_SMSG_TRADE_REQUEST;

            struct TradeCancel : Packet<TradeCancel> {
                uint32_t player_number;
            };
            template<> constexpr uint32_t Packet<TradeCancel>::STATIC_HEADER = GAME_SMSG_TRADE_TERMINATE;

            struct Ping : Packet<Ping> {
                uint32_t ping;
            };
            template<> constexpr uint32_t Packet<Ping>::STATIC_HEADER = GAME_SMSG_PING_REQUEST;

            struct InstanceTimer : Packet<InstanceTimer> {
                uint32_t instance_time;
            };
            template<> constexpr uint32_t Packet<InstanceTimer>::STATIC_HEADER = GAME_SMSG_AGENT_INSTANCE_TIMER;
            ...
            template<> constexpr uint32_t Packet<AgentAdd>::STATIC_HEADER = GAME_SMSG_AGENT_SPAWNED;

            // Called when the client needs to remove an agent from memory (e.g. out of range)
            struct AgentRemove : Packet<AgentRemove> {
                uint32_t agent_id;
            };
            template<> constexpr uint32_t Packet<AgentRemove>::STATIC_HEADER = GAME_SMSG_AGENT_DESPAWNED;

            struct AgentSetPlayer : Packet<AgentSetPlayer> {
                uint32_t unk1;
                uint32_t unk2;
            };
            template<> constexpr uint32_t Packet<AgentSetPlayer>::STATIC_HEADER = GAME_SMSG_AGENT_SET_PLAYER;
            ...
            template<> constexpr uint32_t Packet<AgentUpdateAllegiance>::STATIC_HEADER = GAME_SMSG_AGENT_UPDATE_ALLEGIANCE;
            ...
            template<> constexpr uint32_t Packet<AgentPinged>::STATIC_HEADER = GAME_SMSG_AGENT_PINGED;

            struct PartyRemoveAlly : Packet<PartyRemoveAlly> {
                uint32_t agent_id; // target agent
            };
            template<> constexpr uint32_t Packet<PartyRemoveAlly>::STATIC_HEADER = GAME_SMSG_AGENT_ALLY_DESTROY;
            ...
            template<> constexpr uint32_t Packet<AddExternalBond>::STATIC_HEADER = GAME_SMSG_EFFECT_UPKEEP_APPLIED;
            ...
            template<> constexpr uint32_t Packet<AddEffect>::STATIC_HEADER = GAME_SMSG_EFFECT_APPLIED;
            ...
            template<> constexpr uint32_t Packet<DisplayCape>::STATIC_HEADER = GAME_SMSG_AGENT_DISPLAY_CAPE;
            ...
            template<> constexpr uint32_t Packet<QuestAdd>::STATIC_HEADER = GAME_SMSG_QUEST_ADD;
            ...
            template<> constexpr uint32_t Packet<NpcGeneralStats>::STATIC_HEADER = GAME_SMSG_NPC_UPDATE_PROPERTIES;
            ...
            template<> constexpr uint32_t Packet<NPCModelFile>::STATIC_HEADER = GAME_SMSG_NPC_UPDATE_MODEL;
            ...
            template<> constexpr uint32_t Packet<PlayerJoinInstance>::STATIC_HEADER = GAME_SMSG_AGENT_CREATE_PLAYER;

            struct PlayerLeaveInstance : Packet<PlayerLeaveInstance> {
                uint32_t player_number;
            };
            template<> constexpr uint32_t Packet<PlayerLeaveInstance>::STATIC_HEADER = GAME_SMSG_AGENT_DESTROY_PLAYER;

            // Define chat message
            struct MessageCore : Packet<MessageCore> {
                wchar_t message[122]; // prefixType="int16"
            };
            template<> constexpr uint32_t Packet<MessageCore>::STATIC_HEADER = GAME_SMSG_CHAT_MESSAGE_CORE;
            ...
            template<> constexpr uint32_t Packet<MessageServer>::STATIC_HEADER = GAME_SMSG_CHAT_MESSAGE_SERVER;
            ...
            template<> constexpr uint32_t Packet<MessageNPC>::STATIC_HEADER = GAME_SMSG_CHAT_MESSAGE_NPC;
            ...
            template<> constexpr uint32_t Packet<MessageGlobal>::STATIC_HEADER = GAME_SMSG_CHAT_MESSAGE_GLOBAL;
            ...
            template<> constexpr uint32_t Packet<MessageLocal>::STATIC_HEADER = GAME_SMSG_CHAT_MESSAGE_LOCAL;
            ...
            template<> constexpr uint32_t Packet<PostProcess>::STATIC_HEADER = GAME_SMSG_POST_PROCESS;
            ...
            template<> constexpr uint32_t Packet<DungeonReward>::STATIC_HEADER = GAME_SMSG_DUNGEON_REWARD;
            ...
            template<> constexpr uint32_t Packet<ScreenShake>::STATIC_HEADER = GAME_SMSG_SCREEN_SHAKE;
            ...
            template<> constexpr uint32_t Packet<AgentUnk2>::STATIC_HEADER = GAME_SMSG_NPC_UPDATE_WEAPONS;
            ...
            template<> constexpr uint32_t Packet<MercenaryHeroInfo>::STATIC_HEADER = GAME_SMSG_MERCENARY_INFO;
            ...
            template<> constexpr uint32_t Packet<DialogButton>::STATIC_HEADER = GAME_SMSG_DIALOG_BUTTON;

            struct DialogBody : Packet<DialogBody> {
                wchar_t message[122];
            };
            template<> constexpr uint32_t Packet<DialogBody>::STATIC_HEADER = GAME_SMSG_DIALOG_BODY;

            struct DialogSender : Packet<DialogSender> {
                uint32_t agent_id;
            };
            template<> constexpr uint32_t Packet<DialogSender>::STATIC_HEADER = GAME_SMSG_DIALOG_SENDER;
            ...
            template<> constexpr uint32_t Packet<DataWindow>::STATIC_HEADER = GAME_SMSG_WINDOW_OPEN;

            struct WindowItems : Packet<WindowItems> {
                uint32_t count;
                uint32_t item_ids[16];
            };
            template<> constexpr uint32_t Packet<WindowItems>::STATIC_HEADER = GAME_SMSG_WINDOW_ADD_ITEMS;

            struct WindowItemsEnd : Packet<WindowItemsEnd> {
                uint32_t unk1;
            };
            template<> constexpr uint32_t Packet<WindowItemsEnd>::STATIC_HEADER = GAME_SMSG_WINDOW_ITEMS_END;

            struct ItemStreamEnd : Packet<ItemStreamEnd> { // AKA ItemPricesEnd
                uint32_t unk1;
            };
            template<> constexpr uint32_t Packet<ItemStreamEnd>::STATIC_HEADER = GAME_SMSG_WINDOW_ITEM_STREAM_END;
            ...
            template<> constexpr uint32_t Packet<CompassEvent>::STATIC_HEADER = GAME_SMSG_COMPASS_DRAWING;
            ...
            template<> constexpr uint32_t Packet<MapsUnlocked>::STATIC_HEADER = GAME_SMSG_MAPS_UNLOCKED;

            struct CartographyData : Packet<CartographyData> {
                uint32_t data_length;
                uint32_t data[64];
            };
            template<> constexpr uint32_t Packet<CartographyData>::STATIC_HEADER = GAME_SMSG_CARTOGRAPHY_DATA;

            struct AgentScale : Packet<AgentScale> {
                uint32_t agent_id;
                uint32_t scale;
            };
            template<> constexpr uint32_t Packet<AgentScale>::STATIC_HEADER = GAME_SMSG_AGENT_UPDATE_SCALE;

            struct AgentName : Packet<AgentName> {
                uint32_t agent_id;
                wchar_t name_enc[40];
            };
            template<> constexpr uint32_t Packet<AgentName>::STATIC_HEADER = GAME_SMSG_AGENT_UPDATE_NPC_NAME;
            ...
            template<> constexpr uint32_t Packet<DisplayDialogue>::STATIC_HEADER = GAME_SMSG_AGENT_DISPLAY_DIALOG;
            ...
            template<> constexpr uint32_t Packet<GenericValue>::STATIC_HEADER = GAME_SMSG_AGENT_ATTR_UPDATE_INT;
            ...
            template<> constexpr uint32_t Packet<GenericValueTarget>::STATIC_HEADER = GAME_SMSG_AGENT_ATTR_UPDATE_INT_TARGET;
            ...
            template<> constexpr uint32_t Packet<PlayEffect>::STATIC_HEADER = GAME_SMSG_AGENT_ATTR_PLAY_EFFECT;
            ...
            template<> constexpr uint32_t Packet<AgentProjectileLaunched>::STATIC_HEADER = GAME_SMSG_AGENT_PROJECTILE_LAUNCHED;
            ...
            template<> constexpr uint32_t Packet<SpeechBubble>::STATIC_HEADER = GAME_SMSG_SPEECH_BUBBLE;
            ...
            template<> constexpr uint32_t Packet<PartyAllyAdd>::STATIC_HEADER = GAME_SMSG_AGENT_CREATE_NPC;
            ...
            template<> constexpr uint32_t Packet<AgentModel>::STATIC_HEADER = GAME_SMSG_UPDATE_AGENT_MODEL;
            ...
            template<> constexpr uint32_t Packet<PartyUpdateSize>::STATIC_HEADER = GAME_SMSG_UPDATE_AGENT_PARTYSIZE;
            ...
            template<> constexpr uint32_t Packet<ObjectiveAdd>::STATIC_HEADER = GAME_SMSG_MISSION_OBJECTIVE_ADD;

            struct ObjectiveDone : Packet<ObjectiveDone> {
                uint32_t objective_id;
            };
            template<> constexpr uint32_t Packet<ObjectiveDone>::STATIC_HEADER = GAME_SMSG_MISSION_OBJECTIVE_COMPLETE;

            struct ObjectiveUpdateName : Packet<ObjectiveUpdateName> {
                uint32_t objective_id;
                wchar_t objective_name[128];
            };
            template<> constexpr uint32_t Packet<ObjectiveUpdateName>::STATIC_HEADER = GAME_SMSG_MISSION_OBJECTIVE_UPDATE_STRING;

            struct OpenMerchantWindow : Packet<OpenMerchantWindow> {
                uint32_t type;
                uint32_t unk;
            };
            template<> constexpr uint32_t Packet<OpenMerchantWindow>::STATIC_HEADER = GAME_SMSG_WINDOW_MERCHANT;

            struct WindowOwner : Packet<WindowOwner> {
                uint32_t agent_id;
            };
            template<> constexpr uint32_t Packet<WindowOwner>::STATIC_HEADER = GAME_SMSG_WINDOW_OWNER;

            struct TransactionDone : Packet<TransactionDone> {
                uint32_t unk1;
            };
            template<> constexpr uint32_t Packet<TransactionDone>::STATIC_HEADER = GAME_SMSG_TRANSACTION_DONE;
            struct UpdateSkillbarSkill : Packet<UpdateSkillbarSkill> {
                uint32_t agent_id;
                uint32_t skill_slot;
                uint32_t skill_id;
            };
            template<> constexpr uint32_t Packet<UpdateSkillbarSkill>::STATIC_HEADER = GAME_SMSG_SKILLBAR_UPDATE_SKILL;
            ...
            template<> constexpr uint32_t Packet<UpdateSkillCountAfterMapLoad>::STATIC_HEADER = GAME_SMSG_SKILL_UPDATE_SKILL_COUNT_1;
            ...
            template<> constexpr uint32_t Packet<UpdateSkillCountPreMapLoad>::STATIC_HEADER = GAME_SMSG_SKILL_UPDATE_SKILL_COUNT_2;
            ...
            template<> constexpr uint32_t Packet<SkillActivate>::STATIC_HEADER = GAME_SMSG_SKILL_ACTIVATE;
            ...
            template<> constexpr uint32_t Packet<SkillRecharge>::STATIC_HEADER = GAME_SMSG_SKILL_RECHARGE;
            ...
            template<> constexpr uint32_t Packet<AgentState>::STATIC_HEADER = GAME_SMSG_AGENT_UPDATE_EFFECTS;

            struct MapLoaded : Packet<MapLoaded> {
                // uint32_t
            };
            template<> constexpr uint32_t Packet<MapLoaded>::STATIC_HEADER = GAME_SMSG_INSTANCE_LOADED;

            struct QuotedItemPrice : Packet<QuotedItemPrice> {
                uint32_t itemid;
                uint32_t price;
            };
            template<> constexpr uint32_t Packet<QuotedItemPrice>::STATIC_HEADER = GAME_SMSG_ITEM_PRICE_QUOTE;

            struct WindowPrices : Packet<WindowPrices> {
                uint32_t count;
                uint32_t item_ids[16];
            };
            template<> constexpr uint32_t Packet<WindowPrices>::STATIC_HEADER = GAME_SMSG_ITEM_PRICES;

            struct VanquishProgress : Packet<VanquishProgress> {
                uint32_t foes_killed;
                uint32_t foes_remaining;
            };
            template<> constexpr uint32_t Packet<VanquishProgress>::STATIC_HEADER = GAME_SMSG_VANQUISH_PROGRESS;
            ...
            template<> constexpr uint32_t Packet<VanquishComplete>::STATIC_HEADER = GAME_SMSG_VANQUISH_COMPLETE;

            struct CinematicPlay : Packet<CinematicPlay> {
                uint32_t play;
            };
            template<> constexpr uint32_t Packet<CinematicPlay>::STATIC_HEADER = GAME_SMSG_CINEMATIC_START;
            ...
            template<> constexpr uint32_t Packet<ManipulateMapObject>::STATIC_HEADER = GAME_SMSG_MANIPULATE_MAP_OBJECT;
            ...
            template<> constexpr uint32_t Packet<ManipulateMapObject2>::STATIC_HEADER = GAME_SMSG_MANIPULATE_MAP_OBJECT2;
            ...
            template<> constexpr uint32_t Packet<GuildGeneral>::STATIC_HEADER = GAME_SMSG_GUILD_GENERAL_INFO;
            ...
            template<> constexpr uint32_t Packet<GuildPlayerInfo>::STATIC_HEADER = GAME_SMSG_GUILD_PLAYER_INFO;
            ...
            template<> constexpr uint32_t Packet<ItemUpdateOwner>::STATIC_HEADER = GAME_SMSG_ITEM_UPDATE_OWNER;

            struct ItemCustomisedForPlayer : Packet<ItemCustomisedForPlayer> {
                uint32_t item_id;
                wchar_t player_name[32];
            };
            template<> constexpr uint32_t Packet<ItemCustomisedForPlayer>::STATIC_HEADER = GAME_SMSG_ITEM_UPDATE_NAME;
            ...
            template<> constexpr uint32_t Packet<CharacterAddGold>::STATIC_HEADER = GAME_SMSG_GOLD_CHARACTER_ADD;

            struct SalvageConsumeItem : Packet<SalvageConsumeItem> {
                uint32_t salvage_session_id;
                uint32_t item_id;
            };
            template<> constexpr uint32_t Packet<SalvageConsumeItem>::STATIC_HEADER = GAME_SMSG_ITEM_REMOVE;
            ...
            template<> constexpr uint32_t Packet<CharacterRemoveGold>::STATIC_HEADER = GAME_SMSG_GOLD_CHARACTER_REMOVE;
            ...
            template<> constexpr uint32_t Packet<ItemGeneral>::STATIC_HEADER = GAME_SMSG_ITEM_GENERAL_INFO;
            ...
            template<> constexpr uint32_t Packet<SalvageSession>::STATIC_HEADER = GAME_SMSG_ITEM_SALVAGE_SESSION_START;

            struct SalvageSessionCancel : Packet<SalvageSessionCancel> {
            };
            template<> constexpr uint32_t Packet<SalvageSessionCancel>::STATIC_HEADER = GAME_SMSG_ITEM_SALVAGE_SESSION_CANCEL;

            struct SalvageSessionDone : Packet<SalvageSessionDone> {
            };
            template<> constexpr uint32_t Packet<SalvageSessionDone>::STATIC_HEADER = GAME_SMSG_ITEM_SALVAGE_SESSION_DONE;

            struct SalvageSessionItemKept : Packet<SalvageSessionItemKept> {
            };
            template<> constexpr uint32_t Packet<SalvageSessionItemKept>::STATIC_HEADER = GAME_SMSG_ITEM_SALVAGE_SESSION_ITEM_KEPT;
            ...
            template<> constexpr uint32_t Packet<InstanceLoadFile>::STATIC_HEADER = GAME_SMSG_INSTANCE_LOAD_SPAWN_POINT;
            ...
            template<> constexpr uint32_t Packet<InstanceLoadInfo>::STATIC_HEADER = GAME_SMSG_INSTANCE_LOAD_INFO;
            ...
            template<> constexpr uint32_t Packet<CreateMissionProgress>::STATIC_HEADER = GAME_SMSG_CREATE_MISSION_PROGRESS;
            ...
            template<> constexpr uint32_t Packet<UpdateMissionProgress>::STATIC_HEADER = GAME_SMSG_UPDATE_MISSION_PROGRESS;
            ...
            template<> constexpr uint32_t Packet<GameSrvTransfer>::STATIC_HEADER = GAME_SMSG_TRANSFER_GAME_SERVER_INFO;

            struct DoACompleteZone : Packet<DoACompleteZone> {
                wchar_t message[122];
            };
            template<> constexpr uint32_t Packet<DoACompleteZone>::STATIC_HEADER = GAME_SMSG_DOA_COMPLETE_ZONE;

            struct ErrorMessage : Packet<ErrorMessage> {
                uint32_t message_id;
            };
            template<> constexpr uint32_t Packet<ErrorMessage>::STATIC_HEADER = GAME_SMSG_INSTANCE_TRAVEL_TIMER;
            ...
            template<> constexpr uint32_t Packet<PartyHenchmanAdd>::STATIC_HEADER = GAME_SMSG_PARTY_HENCHMAN_ADD;

            struct PartyHenchmanRemove : Packet<PartyHenchmanRemove> {
                uint32_t party_id;
                uint32_t agent_id;
            };
            template<> constexpr uint32_t Packet<PartyHenchmanRemove>::STATIC_HEADER = GAME_SMSG_PARTY_HENCHMAN_REMOVE;
            ...
            template<> constexpr uint32_t Packet<PartyHeroAdd>::STATIC_HEADER = GAME_SMSG_PARTY_HERO_ADD;
            ...
            template<> constexpr uint32_t Packet<PartyHeroRemove>::STATIC_HEADER = GAME_SMSG_PARTY_HERO_REMOVE;
            ...
            template<> constexpr uint32_t Packet<PartyInviteSent_Create>::STATIC_HEADER = GAME_SMSG_PARTY_INVITE_ADD;
            ...
            template<> constexpr uint32_t Packet<PartyInviteReceived_Create>::STATIC_HEADER = GAME_SMSG_PARTY_JOIN_REQUEST;

            // Remove a sent party invite. Invitation has been cancelled.
            struct PartyInviteSent_Cancel : Packet<PartyInviteSent_Cancel> {
                uint32_t target_party_id; // word
            };
            template<> constexpr uint32_t Packet<PartyInviteSent_Cancel>::STATIC_HEADER = GAME_SMSG_PARTY_INVITE_CANCEL;
            ...
            template<> constexpr uint32_t Packet<PartyInviteReceived_Cancel>::STATIC_HEADER = GAME_SMSG_PARTY_REQUEST_CANCEL;
            ...
            template<> constexpr uint32_t Packet<PartyInviteSent_Response>::STATIC_HEADER = GAME_SMSG_PARTY_REQUEST_RESPONSE;
            ...
            template<> constexpr uint32_t Packet<PartyInviteReceived_Response>::STATIC_HEADER = GAME_SMSG_PARTY_INVITE_RESPONSE;
            ...
            template<> constexpr uint32_t Packet<PartyPlayerAdd>::STATIC_HEADER = GAME_SMSG_PARTY_PLAYER_ADD;
            // Player has left party. Not necessarily yours.
            struct PartyPlayerRemove : Packet<PartyPlayerRemove> {
                uint32_t party_id;
                uint32_t player_id;
            };
            template<> constexpr uint32_t Packet<PartyPlayerRemove>::STATIC_HEADER = GAME_SMSG_PARTY_PLAYER_REMOVE;
            ...
            template<> constexpr uint32_t Packet<PartyPlayerStreamStart>::STATIC_HEADER = GAME_SMSG_PARTY_CREATE;
            struct PartyPlayerStreamEnd : Packet<PartyPlayerStreamEnd> {
                uint32_t party_id; // word
            };
            template<> constexpr uint32_t Packet<PartyPlayerStreamEnd>::STATIC_HEADER = GAME_SMSG_PARTY_MEMBER_STREAM_END;

            struct PartyDefeated : Packet<PartyDefeated> {
            };
            template<> constexpr uint32_t Packet<PartyDefeated>::STATIC_HEADER = GAME_SMSG_PARTY_DEFEATED;
            ...
            template<> constexpr uint32_t Packet<PartyLock>::STATIC_HEADER = GAME_SMSG_PARTY_LOCK;

            struct CapeVisibility : Packet<CapeVisibility> {
                uint32_t agent_id;
                uint32_t visible; // 0 or 1
            };
            template<> constexpr uint32_t Packet<CapeVisibility>::STATIC_HEADER = GAME_SMSG_AGENT_DISPLAY_CAPE;
            ...
            template<> constexpr uint32_t Packet<InstanceLoadStart>::STATIC_HEADER = GAME_SMSG_INSTANCE_LOAD_HEAD;
            ...
            template<> constexpr uint32_t Packet<ItemGeneral_FirstID>::STATIC_HEADER = GAME_SMSG_ITEM_GENERAL_INFO;

            struct ItemGeneral_ReuseID : ItemGeneral_FirstID {};
            template<> constexpr uint32_t Packet<ItemGeneral_ReuseID>::STATIC_HEADER = GAME_SMSG_ITEM_REUSE_ID;

            struct PlayerIsPartyLeader : Packet<PlayerIsPartyLeader> {
                uint32_t is_leader; // bool
            };
            template<> constexpr uint32_t Packet<PlayerIsPartyLeader>::STATIC_HEADER = GAME_SMSG_PARTY_YOU_ARE_LEADER;

            struct RemoveEffect : Packet<RemoveEffect> {
                GW::AgentID agent_id;
                unsigned effect_id; // not GW::SkillID
            };
            template<> constexpr uint32_t Packet<RemoveEffect>::STATIC_HEADER = GAME_SMSG_EFFECT_REMOVED;
            ...
            template<> constexpr uint32_t Packet<SkillRecharged>::STATIC_HEADER = GAME_SMSG_SKILL_RECHARGED;
            ...
            template<> constexpr uint32_t Packet<UpdateGuildInfo>::STATIC_HEADER = GAME_SMSG_GUILD_GENERAL_INFO;

            struct UpdateTitle : Packet<UpdateTitle> {
                uint32_t title_id;
                uint32_t new_value;
            };
            template<> constexpr uint32_t Packet<UpdateTitle>::STATIC_HEADER = GAME_SMSG_TITLE_UPDATE;
            ...
            template<> constexpr uint32_t Packet<TitleInfo>::STATIC_HEADER = GAME_SMSG_TITLE_TRACK_INFO;
            ...
            template<> constexpr uint32_t Packet<PlayerAttrUpdate>::STATIC_HEADER = GAME_SMSG_PLAYER_ATTR_UPDATE;
            ...
            template<> constexpr uint32_t Packet<PlayerAttrSet>::STATIC_HEADER = GAME_SMSG_PLAYER_ATTR_SET;
        }
    }
}
