...
void PconPanel::BuildUI() {
	...
	grail = new PconCons(this, L"grail");
	...
	armor = new PconCons(this, L"armor");
	...
	redrock = new Pcon(this, L"redrock");
	...
	bluerock = new Pcon(this, L"bluerock");
	...
	greenrock = new Pcon(this, L"greenrock");
	...
	cupcake = new Pcon(this, L"cupcake");
	...
	warsupply = new Pcon(this, L"warsupply");
	...
	alcohol = new PconAlcohol(this, L"alcohol");
	...
	lunars = new PconLunar(this, L"lunars");
	...
	skalesoup = new Pcon(this, L"skalesoup");
