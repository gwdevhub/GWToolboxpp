...
wstring TravelPanel::IndexToOutpostName(int index) {
	...
	case 4: return wstring(L"Amnoon Oasis, The");
	case 5: return wstring(L"Arborstone");
	case 6: return wstring(L"Ascalon City");
	case 7: return wstring(L"Aspenwood Gate (Kurzick)");
	case 8: return wstring(L"Aspenwood Gate (Luxon)");
	case 9: return wstring(L"Astralarium, The");
	case 10: return wstring(L"Augury Rock");
	case 11: return wstring(L"Aurios Mines, The");
	case 12: return wstring(L"Aurora Glade");
	case 13: return wstring(L"Bai Paasu Reach");
	case 14: return wstring(L"Basalt Grotto");
	case 15: return wstring(L"Beacon's Perch");
	case 16: return wstring(L"Beetletun");
	case 17: return wstring(L"Beknur Harbor");
	case 18: return wstring(L"Bergen Hot Springs");
	case 19: return wstring(L"Blacktide Den");
	case 20: return wstring(L"Bloodstone Fen");
	case 21: return wstring(L"Bone Palace");
	case 22: return wstring(L"Boreal Station");
	case 23: return wstring(L"Boreas Seabed");
	case 24: return wstring(L"Borlis Pass");
	case 25: return wstring(L"Brauer Academy");
	case 26: return wstring(L"Breaker Hollow");
	case 27: return wstring(L"Camp Hojanu");
	case 28: return wstring(L"Camp Rankor");
	case 29: return wstring(L"Cavalon");
	case 30: return wstring(L"Central Transfer Chamber");
	case 31: return wstring(L"Chahbek Village");
	case 32: return wstring(L"Champion's Dawn");
	case 33: return wstring(L"Chantry of Secrets");
	case 34: return wstring(L"Codex Arena");
	case 35: return wstring(L"Consulate Docks");
	case 36: return wstring(L"Copperhammer Mines");
	case 37: return wstring(L"D'Alessio Seaboard");
	case 38: return wstring(L"Dajkah Inlet");
	case 39: return wstring(L"Dasha Vestibule");
	case 40: return wstring(L"Deep, The");
	case 41: return wstring(L"Deldrimor War Camp");
	case 42: return wstring(L"Destiny's Gorge");
	case 43: return wstring(L"Divinity Coast");
	case 44: return wstring(L"Doomlore Shrine");
	case 45: return wstring(L"Dragon's Lair, The");
	case 46: return wstring(L"Dragon's Throat");
	case 47: return wstring(L"Droknar's Forge");
	case 48: return wstring(L"Druid's Overlook");
	case 49: return wstring(L"Dunes of Despair");
	case 50: return wstring(L"Durheim Archives");
	case 51: return wstring(L"Dzagonur Bastion");
	case 52: return wstring(L"Elona Reach");
	case 53: return wstring(L"Embark Beach");
	case 54: return wstring(L"Ember Light Camp");
	case 55: return wstring(L"Eredon Terrace");
	case 56: return wstring(L"Eternal Grove, The");
	case 57: return wstring(L"Eye of the North");
	case 58: return wstring(L"Fishermen's Haven");
	case 59: return wstring(L"Fort Aspenwood (Kurzick)");
	case 60: return wstring(L"Fort Aspenwood (Luxon)");
	case 61: return wstring(L"Fort Ranik");
	case 62: return wstring(L"Frontier Gate");
	case 63: return wstring(L"Frost Gate, The");
	case 64: return wstring(L"Gadd's Encampment");
	case 65: return wstring(L"Gate of Anguish");
	case 66: return wstring(L"Gate of Desolation");
	case 67: return wstring(L"Gate of Fear");
	case 68: return wstring(L"Gate of Madness");
	case 69: return wstring(L"Gate of Pain");
	case 70: return wstring(L"Gate of Secrets");
	case 71: return wstring(L"Gate of the Nightfallen Lands");
	case 72: return wstring(L"Gate of Torment");
	case 73: return wstring(L"Gates of Kryta");
	case 74: return wstring(L"Grand Court of Sebelkeh");
	case 75: return wstring(L"Granite Citadel, The");
	case 76: return wstring(L"Great Northern Wall, The");
	case 77: return wstring(L"Great Temple of Balthazar");
	case 78: return wstring(L"Grendich Courthouse");
	case 79: return wstring(L"Gunnar's Hold");
	case 80: return wstring(L"Gyala Hatchery");
	case 81: return wstring(L"Harvest Temple");
	case 82: return wstring(L"Hell's Precipice");
	case 83: return wstring(L"Henge of Denravi");
	case 84: return wstring(L"Heroes' Ascent");
	case 85: return wstring(L"Heroes' Audience");
	case 86: return wstring(L"Honur Hill");
	case 87: return wstring(L"House zu Heltzer");
	case 88: return wstring(L"Ice Caves of Sorrow");
	case 89: return wstring(L"Ice Tooth Cave");
	case 90: return wstring(L"Imperial Sanctum");
	case 91: return wstring(L"Iron Mines of Moladune");
	case 92: return wstring(L"Jade Flats (Kurzick)");
	case 93: return wstring(L"Jade Flats (Luxon)");
	case 94: return wstring(L"Jade Quarry (Kurzick), The");
	case 95: return wstring(L"Jade Quarry (Luxon), The");
	case 96: return wstring(L"Jennur's Horde");
	case 97: return wstring(L"Jokanur Diggings");
	case 98: return wstring(L"Kaineng Center");
	case 99: return wstring(L"Kamadan, Jewel of Istan");
	case 100: return wstring(L"Kodash Bazaar, The");
	case 101: return wstring(L"Kodlonu Hamlet");
	case 102: return wstring(L"Kodonur Crossroads");
	case 103: return wstring(L"Lair of the Forgotten");
	case 104: return wstring(L"Leviathan Pits");
	case 105: return wstring(L"Lion's Arch");
	case 106: return wstring(L"Longeye's Ledge");
	case 107: return wstring(L"Lutgardis Conservatory");
	case 108: return wstring(L"Maatu Keep");
	case 109: return wstring(L"Maguuma Stade");
	case 110: return wstring(L"Marhan's Grotto");
	case 111: return wstring(L"Marketplace, The");
	case 112: return wstring(L"Mihanu Township");
	case 113: return wstring(L"Minister Cho's Estate");
	case 114: return wstring(L"Moddok Crevice");
	case 115: return wstring(L"Mouth of Torment, The");
	case 116: return wstring(L"Nahpui Quarter");
	case 117: return wstring(L"Nolani Academy");
	case 118: return wstring(L"Nundu Bay");
	case 119: return wstring(L"Olafstead");
	case 120: return wstring(L"Piken Square");
	case 121: return wstring(L"Pogahn Passage");
	case 122: return wstring(L"Port Sledge");
	case 123: return wstring(L"Quarrel Falls");
	case 124: return wstring(L"Raisu Palace");
	case 125: return wstring(L"Ran Musu Gardens");
	case 126: return wstring(L"Random Arenas");
	case 127: return wstring(L"Rata Sum");
	case 128: return wstring(L"Remains of Sahlahja");
	case 129: return wstring(L"Rilohn Refuge");
	case 130: return wstring(L"Ring of Fire");
	case 131: return wstring(L"Riverside Province");
	case 132: return wstring(L"Ruins of Morah");
	case 133: return wstring(L"Ruins of Surmia");
	case 134: return wstring(L"Saint Anjeka's Shrine");
	case 135: return wstring(L"Sanctum Cay");
	case 136: return wstring(L"Sardelac Sanitarium");
	case 137: return wstring(L"Seafarer's Rest");
	case 138: return wstring(L"Seeker's Passage");
	case 139: return wstring(L"Seitung Harbor");
	case 140: return wstring(L"Senji's Corner");
	case 141: return wstring(L"Serenity Temple");
	case 142: return wstring(L"Shadow Nexus, The");
	case 143: return wstring(L"Shing Jea Arena");
	case 144: return wstring(L"Shing Jea Monastery");
	case 145: return wstring(L"Sifhalla");
	case 146: return wstring(L"Sunjiang District");
	case 147: return wstring(L"Sunspear Arena");
	case 148: return wstring(L"Sunspear Great Hall");
	case 149: return wstring(L"Sunspear Sanctuary");
	case 150: return wstring(L"Tahnnakai Temple");
	case 151: return wstring(L"Tanglewood Copse");
	case 152: return wstring(L"Tarnished Haven");
	case 153: return wstring(L"Temple of the Ages");
	case 154: return wstring(L"Thirsty River");
	case 155: return wstring(L"Thunderhead Keep");
	case 156: return wstring(L"Tihark Orchard");
	case 157: return wstring(L"Tomb of the Primeval Kings");
	case 158: return wstring(L"Tsumei Village");
	case 159: return wstring(L"Umbral Grotto");
	case 160: return wstring(L"Unwaking Waters (Kurzick)");
	case 161: return wstring(L"Unwaking Waters (Luxon)");
	case 162: return wstring(L"Urgoz's Warren");
	case 163: return wstring(L"Vasburg Armory");
	case 164: return wstring(L"Venta Cemetery");
	case 165: return wstring(L"Ventari's Refuge");
	case 166: return wstring(L"Vizunah Square (Foreign Quarter)");
	case 167: return wstring(L"Vizunah Square (Local Quarter)");
	case 168: return wstring(L"Vlox's Falls");
	case 169: return wstring(L"Wehhan Terraces");
	case 170: return wstring(L"Wilds, The");
	case 171: return wstring(L"Yahnur Market");
	case 172: return wstring(L"Yak's Bend");
	case 173: return wstring(L"Yohlon Haven");
	case 174: return wstring(L"Zaishen Challenge");
	case 175: return wstring(L"Zaishen Elite");
	case 176: return wstring(L"Zaishen Menagerie");
	case 177: return wstring(L"Zen Daijun");
	case 178: return wstring(L"Zin Ku Corridor");
	case 179: return wstring(L"Zos Shivros Channel");
