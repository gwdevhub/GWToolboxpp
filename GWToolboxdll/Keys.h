...
static const char* KeyName(const long vkey)
{
    switch (vkey) {
        ...
        case VK_OEM_8:
            return "Oem 8";
        case 0xE0:
            return "VK_0xE0"; // reserved
        case 0xE1:
            return "VK_0xE1"; // OEM specific
        case VK_OEM_102:
            return "Oem 10";
        case 0xE3:
            return "VK_0xE3"; // oem specific
        case 0xE4:
            return "VK_0xE4"; // oem specific
        case VK_PROCESSKEY:
            return "IME Process";
        case 0xE6:
            return "VK_0xE6"; // oem specific
        case VK_PACKET:
            return "Packet";
        // 0xE8 -> unassigned
        case 0xE9:
