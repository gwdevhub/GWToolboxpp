...
private:
    ...
    enum class QuestDialogType {
        ENQUIRE = 0x800003,
        // Quest available - green exclamation mark
        TAKE = 0x800001,
        // Add this quest to my log - green tick mark
        ENQUIRE_NEXT = 0x800004,
        // Progressing on a current quest - green speech bubble
        RECAP = 0x800005,
        // You've already taken the quest - yellow question mark
        ENQUIRE_REWARD = 0x800006,
        // Quest completed, discuss reward - green speech bubble
