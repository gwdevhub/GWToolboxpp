...
void InventoryManager::ItemClickCallback(GW::HookStatus* status, const uint32_t type, const uint32_t slot, const GW::Bag* bag)
{
    ...
    switch (type) {
        case 7: // Left click
            if (ImGui::IsKeyDown(ImGuiKey_ModCtrl) && !ImGui::IsKeyDown(ImGuiKey_ModAlt)
            ...
            else if (ImGui::IsKeyDown(ImGuiKey_ModAlt) && !ImGui::IsKeyDown(ImGuiKey_ModCtrl) && IsTradeWindowOpen()
