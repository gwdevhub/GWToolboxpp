...
void VendorFix::Initialize() {
    ...
    Collector_Create_UICtlCallback_Func = (UICtlCallback)GW::Scanner::FindAssertion("p:\\code\\gw\\ui\\game\\vendor\\vncollect.cpp", "collect.service == CHAR_TRANSACTION_COLLECT", -0x47);
    ...
    Crafter_Create_UICtlCallback_Func = (UICtlCallback)GW::Scanner::FindAssertion("p:\\code\\gw\\ui\\game\\vendor\\vncraft.cpp", "service.service == CHAR_TRANSACTION_CRAFT", -0x37);
