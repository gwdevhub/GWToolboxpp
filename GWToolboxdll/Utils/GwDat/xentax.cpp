...
unsigned char Table5[32] = {0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04,
            ...
            if (_counter1 > -1)
                do
                {
                    ...
                    if (_temp == -1)
                    {
                        ...
                        _data = HuffmanTree.HelperArray[i + 1] -
                          ((unsigned int)(ESIplusC - HuffmanTree.HelperArray[i]) >> (0x20 - _temp));
                    ...
                    else
                    {
                        ...
                        if (_temp == -1)
                        {
                            ...
                            _data = HuffmanTree2.HelperArray[i + 1] -
                              ((unsigned int)(ESIplusC - HuffmanTree2.HelperArray[i]) >> (0x20 - _temp));
