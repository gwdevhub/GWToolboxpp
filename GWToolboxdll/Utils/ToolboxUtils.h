...
namespace ToolboxUtils {
    namespace EncodedStrings {
        ...
        const wchar_t* GetSegmentArgument(const wchar_t* message, wchar_t segment_key, int segment_number = -1, size_t* segment_length_out = nullptr, size_t* identifier_length_out = nullptr);
