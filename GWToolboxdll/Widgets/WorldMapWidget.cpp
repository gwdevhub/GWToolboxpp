...
const EliteBossLocation elite_boss_locations[] = {
    ...
    {GW::Constants::SkillID::Skull_Crack, 01, "Baglorag Grumblesnort", GW::Constants::MapID::Norrhart_Domains, {{1111, 785}}, "Patrolling the area around the nearby stones."},
    {GW::Constants::SkillID::Crippling_Slash, 01, "Fenrir", GW::Constants::MapID::Norrhart_Domains, {{1205, 904}}},
    {GW::Constants::SkillID::Cleave, 01, "Dvalinn Stonebreaker", GW::Constants::MapID::Drakkar_Lake, {{714, 617}}, "Only before \"In the Sevice of Revenge\" quest is completed."},
    {GW::Constants::SkillID::Skull_Crack, 01, "Lann Browsmasher", GW::Constants::MapID::Drakkar_Lake, {{743, 548}}, "He is the goal of \"Nornhood\" quest.\nHe can spawn also in the south of the Lake."},
    {GW::Constants::SkillID::Skull_Crack, 01, "Lann Browsmasher", GW::Constants::MapID::Drakkar_Lake, {{869, 669}}, "He is the goal of \"Nornhood\" quest.\nHe can spawn also in the cave."},
    {GW::Constants::SkillID::Skull_Crack, 01, "Chieftain Ulgrimar", GW::Constants::MapID::Drakkar_Lake, {{932, 525}}, "Only dugin \"The Big Unfriendly Jotun\"."},
    {GW::Constants::SkillID::Earth_Shaker, 01, "Jormungand", GW::Constants::MapID::Drakkar_Lake, {{811, 719}}, "He spawns in this location rarely."},
    {GW::Constants::SkillID::Crippling_Shot, 01, "Koren Wildrunner", GW::Constants::MapID::Drakkar_Lake, {{853, 704}}, "He patrols around the lake via various route."},
    ...
    {GW::Constants::SkillID::Life_Transfer, 01, "Tanto the Grim", GW::Constants::MapID::Varajar_Fells, {{923, 1026}}, "Only during the quest \"Haunted\"."},
    {GW::Constants::SkillID::Mind_Freeze, 01, "Dazehl Brainfreezer", GW::Constants::MapID::Varajar_Fells, {{604, 988}}, "He only spawns if the northwestern side of the lake has been cleared of Ice Imps and Frozen Elementals.\nClaring out the cave is not necessary"},
    {GW::Constants::SkillID::Reapers_Sweep, 01, "Asterius the Mighty", GW::Constants::MapID::Varajar_Fells, {{699, 1012}}, "He patrols around the southwest section of Varajar Fells."},
    {GW::Constants::SkillID::Earth_Shaker, 01, "Jormungand", GW::Constants::MapID::Varajar_Fells, {{777, 1016}}, "He could spawn randomly."},
    ...
    {GW::Constants::SkillID::Healing_Light, 01, "Elmohr Snowmender", GW::Constants::MapID::Bjora_Marches, {{1631, 448}}, "Only during \"Blood Washes Blood\" mission."},
    ...
    {GW::Constants::SkillID::Gladiators_Defense, 01, "Facet of Destruction", GW::Constants::MapID::Verdant_Cascades, {{319, 1380}, {375, 1329}, {177, 1367}}, "He could spawn in one out the three possible locations."},
    ...
    {GW::Constants::SkillID::Backbreaker, 02, "Hodat the Tumbler", GW::Constants::MapID::Dalada_Uplands, {{860, 223}}, "only when Forgotten Relics has been done"},
    {GW::Constants::SkillID::Life_Sheath, 02, "Chaelse Flameshielder", GW::Constants::MapID::Grothmar_Wardowns, {{454, 351}}, "does not spawn between the completion of Against the Charr and the completion of The Dawn of Rebellion, or between completion of \"Be Very, Very Quiet...\" and the completion of \"Plan A\"."},
    {GW::Constants::SkillID::Ride_the_Lightning, 02, "Thraexis Thundermaw", GW::Constants::MapID::Grothmar_Wardowns, {{335, 312}}},
    {GW::Constants::SkillID::Barrage, 02, "Groknar Weazlewortz", GW::Constants::MapID::Grothmar_Wardowns, {{404, 283}}, "During Against the Charr - at the Supply Caravan (part of the mission bonus)"},
    {GW::Constants::SkillID::Eviscerate, 02, "Gordam Griefgiver", GW::Constants::MapID::Grothmar_Wardowns, {{440, 322}}, "During \"Against the Charr\""},
    {GW::Constants::SkillID::Ward_Against_Harm, 02, "Frazar Frostfur", GW::Constants::MapID::Grothmar_Wardowns, {{450, 425}}, "During \"Against the Charr\""},
    ...
    {GW::Constants::SkillID::Searing_Flames, 02, "Borrguus Blisterbark", GW::Constants::MapID::Sacnoth_Valley, {{830, 671}}, "Patrolling all around the forest"},
    {GW::Constants::SkillID::Power_Block, 02, "Anmat the Trickster", GW::Constants::MapID::Sacnoth_Valley, {{680, 504}}},
    {GW::Constants::SkillID::Power_Block, 02, "Anmat the Trickster", GW::Constants::MapID::Sacnoth_Valley, {{426, 322}}, "During \"Against the Charr\""},
    {GW::Constants::SkillID::Reapers_Mark, 02, "Rend Ragemauler", GW::Constants::MapID::Sacnoth_Valley, {{809, 461}}, "During \"The Assassin's Revenge\""},
    {GW::Constants::SkillID::Reapers_Mark, 02, "Vyrrgis the Pestilent", GW::Constants::MapID::Sacnoth_Valley, {{669, 524}}, "During \"Single Ugly Grawl Seeks Same for Mindless Destruction in Ascalon\""},
    {GW::Constants::SkillID::Eviscerate, 02, "Gharaz the Glutton", GW::Constants::MapID::Sacnoth_Valley, {{643, 517}}, "During \"Forbidden Fruit\""},
    {GW::Constants::SkillID::Life_Transfer, 02, "Katye Bloodburner", GW::Constants::MapID::Sacnoth_Valley, {{642, 499}}},
    {GW::Constants::SkillID::Forceful_Blow, 02, "Ignus the Eternal", GW::Constants::MapID::Sacnoth_Valley, {{838, 685}}, "Only during \"The Smell of Titan in the Morning\""},
    ...
    {GW::Constants::SkillID::Together_as_one, 02, "Fureyst Sharpsight", GW::Constants::MapID::Sacnoth_Valley, {{640, 700}}, "Only if a player carries a \"Proof of Triumph\""},
    {GW::Constants::SkillID::Time_Ward, 02, "Fureyst Sharpsight", GW::Constants::MapID::Sacnoth_Valley, {{660, 700}}, "Only if a player carries a \"Proof of Triumph\""},
    {GW::Constants::SkillID::Ether_Prodigy, 02, "Hierophant Burntsoul", GW::Constants::MapID::Sacnoth_Valley, {{655, 484}}, "During \"Assault on the Stronghold \" mission"},
    ...
    {GW::Constants::SkillID::Melandrus_Resilience, 03, "Facet of Creation", GW::Constants::MapID::Alcazia_Tangle, {{740, 502}}, "during the \"Cipher of Melandru\"\nKnown spawn locations:\n- Northeast, west of the river (see map)\n- Northwest of center, in the patch of dirt surrounded by stones west of Reesou the Wanderer and north of a pond\n- West of center, at the top of the cliff\n- Northwest, near the exit into Magus Stones"},
    {GW::Constants::SkillID::Word_of_Healing, 03, "Flannuss Broadwing", GW::Constants::MapID::Arbor_Bay, {{1199, 212}}, "His route is approximately 5 minutes in length, varying in direction and path per spawn. Generally, he patrols around the edge of the northeastern lagoon."},
    {GW::Constants::SkillID::Crippling_Anguish, 03, "Alitta Guilebloom", GW::Constants::MapID::Arbor_Bay, {{1086, 315}}, "Patrolling all around this area, southern of the central island."},
    {GW::Constants::SkillID::Pious_Renewal, 03, "Facet of Spirit", GW::Constants::MapID::Arbor_Bay, {{1188, 171}}, "During \"the Cipher of Kormir\"\nKnown spawn locations:\n- In the waters directly south of Vlox's Falls.\n- Northeast of center, at the top of the hill northwest of the the northeastern lagoon\n- In the waters southwest of Ventari's Sanctuary.\n- In the waters directly east of Ventari's Sanctuary."},
    ...
    {GW::Constants::SkillID::Mantra_of_Recall, 03, "Facet of Illusions", GW::Constants::MapID::Magus_Stones, {{258, 262}}, "during \"the Cipher of Lyssa\" quest\nKnown spawn locations:\n- In the pond west of Rata Sum.\n- Northwest from the center, between the large clearing and the waterfall.\n- South of center between the three hills.\n- Far northwest corner."},
    {GW::Constants::SkillID::Stunning_Strike, 03, "Timberland Guardian", GW::Constants::MapID::Magus_Stones, {{50, 240}}, "during \"Lab Space\" quest."},
    ...
    {GW::Constants::SkillID::Devastating_Hammer, 03, "Inscribed Sentry", GW::Constants::MapID::Sparkfly_Swamp, {{4218, 6625}}, "Ettin met during \"Finding the Bloodstone\" quest."},
    {GW::Constants::SkillID::Grenths_Balance, 03, "Facet of Death", GW::Constants::MapID::Sparkfly_Swamp, {{4140, 6600}}, "During \"the Cipher of Grenth\" quest.\nKnown spawn locations:\n- Eastern edge of the central clearing, up the hill south of the easternmost edge of the swamp.\n- Southeast of center, at the three way crossroads north of the resurrection shrine (see map).\n- Northeast of center, at the three way crossroads between the resurrection shrine at the eastern edge of the swamp and Brynn Earthporter's alcove (see map).\n- In the center of the Agari territory."},
    {GW::Constants::SkillID::Migraine, 03, "Waray Skullflayer", GW::Constants::MapID::Sparkfly_Swamp, {{4100, 6437}}, "Waray Skullflayer will not spawn if you have quest Frogstomp active."},
    {GW::Constants::SkillID::Ebon_Dust_Aura, 03, "Brynn Earthporter", GW::Constants::MapID::Sparkfly_Swamp, {{4375, 6310}}},
    {GW::Constants::SkillID::Ravenous_Gaze, 01, "Moa'vu'Kaal", GW::Constants::MapID::Issnur_Isles, {{1059, 798}}, "Only during the quest Moa'vu'Kaal, Awakened"},
    ...
    {GW::Constants::SkillID::Barrage, 02, "Commander Kubeh", GW::Constants::MapID::Arkjok_Ward, {{824, 1045}}, "only during \"The Great Escape\""},
    {GW::Constants::SkillID::Depravity, 02, "Modti Darkflower", GW::Constants::MapID::Arkjok_Ward, {{753, 1051}}},
    {GW::Constants::SkillID::Enchanters_Conundrum, 02, "Captain Chichor", GW::Constants::MapID::Arkjok_Ward, {{812, 1005}}, "patroling the 3 islands around\nnot during \"The Great Escape\""},
    {GW::Constants::SkillID::Lightning_Surge, 02, "Zephyr Hedger", GW::Constants::MapID::Arkjok_Ward, {{640, 921}}, "only during the \"Koss's Elixir quest\""},
    ...
    {GW::Constants::SkillID::Crippling_Anthem, 02, "Lieutenant Shagu", GW::Constants::MapID::Barbarous_Shore, {{1466, 1245}}, "not during \"The Follhardy Father\""},
    {GW::Constants::SkillID::Blood_is_Power, 02, "Overseer Vanakh", GW::Constants::MapID::Dejarin_Estate, {{1168, 954}}, "only during \"Kodonur Crossroads Mission\""},
    {GW::Constants::SkillID::Zealous_Benediction, 02, "Overseer Sadi-Belai", GW::Constants::MapID::Dejarin_Estate, {{1142, 893}}, "only during \"Kodonur Crossroads Mission\""},
    {GW::Constants::SkillID::Pious_Renewal, 02, "Overseer Suli", GW::Constants::MapID::Dejarin_Estate, {{1078, 1020}}, "only during \"Kodonur Crossroads Mission\""},
    {GW::Constants::SkillID::Cautery_Signet, 02, "Overseer Boktek", GW::Constants::MapID::Dejarin_Estate, {{991, 1085}}, "only during \"Kodonur Crossroads Mission\""},
    ...
    {GW::Constants::SkillID::Arcane_Zeal, 02, "Zealot Sheoli", GW::Constants::MapID::Marga_Coast, {{377, 800}}, "only during \"Nundu Bay Mission\"\none of the attacking Margonites"},
    {GW::Constants::SkillID::Anthem_of_Guidance, 02, "Commander Chutal", GW::Constants::MapID::Marga_Coast, {{384, 816}}, "only during \"Nundu Bay Mission\"\none of the attacking Margonites"},
    {GW::Constants::SkillID::Invoke_Lightning, 02, "Scribe Wensal", GW::Constants::MapID::Marga_Coast, {{393, 827}}, "only during \"Nundu Bay Mission\"\none of the attacking Margonites"},
    {GW::Constants::SkillID::Spell_Breaker, 02, "Priest Zein Zuu", GW::Constants::MapID::Marga_Coast, {{412, 824}}, "only during \"Nundu Bay Mission\"\none of the attacking Margonites"},
    ...
    {GW::Constants::SkillID::Reapers_Sweep, 02, "Dabineh Deathbringer", GW::Constants::MapID::Sunward_Marches, {{380, 594}}, "spawn if no quest is active"},
    ...
    {GW::Constants::SkillID::Corrupt_Enchantment, 02, "Torment Weaver", GW::Constants::MapID::Turais_Procession, {{552, 271}}, "only during \"Battle of Turai's Procession\""},
    {GW::Constants::SkillID::Mantra_of_Recovery, 02, "Olunoss Windwalker", GW::Constants::MapID::Turais_Procession, {{580, 288}}, "spawn after completition of Battle's of Turai's Procession\""},
    {GW::Constants::SkillID::Searing_Flames, 02, "Korr, Living Flame", GW::Constants::MapID::Turais_Procession, {{545, 96}}},
    {GW::Constants::SkillID::Grenths_Grasp, 02, "Lord Yama the Vengeful", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1351, 473}}, "only during \"Drakes on the Plain\""},
    ...
    {GW::Constants::SkillID::Quick_Shot, 02, "Zelnehlun Fastfoot", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1247, 494}}, "not during \"Drakes on the Plain\""},
    {GW::Constants::SkillID::Decapitate, 02, "Robah Hardback", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1288, 683}}},
    {GW::Constants::SkillID::Tainted_Flesh, 02, "Jerneh Nightbringer", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1278, 660}}, "This boss spawns from the ground when you get close to the location"},
    {GW::Constants::SkillID::Sandstorm, 02, "The Drought", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1351, 519}}, "only durin \"Rilhon Refuge Mission\"\nowned by THE DROUGHT"},
    ...
    {GW::Constants::SkillID::Devastating_Hammer, 02, "Churrta the Rock", GW::Constants::MapID::Jahai_Bluffs, {{900, 697}}, "(not during the quest Eavesdropping)"},
    ...
    {GW::Constants::SkillID::Cruel_Spear, 02, "Yakun Trueshot", GW::Constants::MapID::Bahdok_Caverns, {{1466, 340}}, "only during \"Moddok Crevice Mission\"\nYou will have to enter the passage Dunkoro tells you to avoid, so you will be unable to kill this boss and get the bonus at the same time"},
    {GW::Constants::SkillID::Light_of_Deliverance, 02, "Kenmak the Tranquil", GW::Constants::MapID::Bahdok_Caverns, {{1463, 355}}, "only during \"Moddok Crevice Mission\"\nYou will have to enter the passage Dunkoro tells you to avoid, so you will be unable to kill this boss and get the bonus at the same time"},
    {GW::Constants::SkillID::Magehunter_Strike, 02, "Captain Kavaka", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{907, 1345}}, "during \"Consulate Docks Mission\""},
    {GW::Constants::SkillID::Master_of_Magic, 02, "Captain Mwende", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{883, 1352}}, "during \"Consulate Docks Mission\""},
    {GW::Constants::SkillID::Cautery_Signet, 02, "Captain Lumanda", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{790, 1351}}, "during \"Consulate Docks Mission\""},
    {GW::Constants::SkillID::Pious_Renewal, 02, "Captain Denduru", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{822, 1344}}, "during \"Consulate Docks Mission\""},
    {GW::Constants::SkillID::Magehunter_Strike, 02, "Executioner Vekil", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{900, 1218}}, "during \"Pogahn Passage Mission\""},
    {GW::Constants::SkillID::Enchanters_Conundrum, 02, "Lieutenant Nali", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{906, 1328}}, "during \"Pogahn Passage Mission\""},
    {GW::Constants::SkillID::Master_of_Magic, 02, "Captain Nebo", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{823, 1366}}, "during \"Pogahn Passage Mission\""},
    ...
    {GW::Constants::SkillID::Wastrels_Collapse, 03, "Jarimiya the Unmerciful", GW::Constants::MapID::Vehtendi_Valley, {{997, 981}}, "not during \"Rally The Princess\" quest \n not during \"Valley of the Rifts\" quest"},
    ...
    {GW::Constants::SkillID::Anthem_of_Guidance, 03, "Briahn the Chosen", GW::Constants::MapID::The_Mirror_of_Lyss, {{1130, 616}}, "he travels back and forth between Honur Hill and The Kodash Bazar"},
    ...
    {GW::Constants::SkillID::Incoming, 03, "Kunan the Loudmouth", GW::Constants::MapID::Wilderness_of_Bahdza, {{1530, 384}}, "only after the quest \"Extinction\""},
    {GW::Constants::SkillID::Incoming, 03, "Screecher", GW::Constants::MapID::Wilderness_of_Bahdza, {{1540, 549}}, "only before completion of \"Destroy the Harpies\""},
    {GW::Constants::SkillID::Incoming, 03, "Scratcher", GW::Constants::MapID::Wilderness_of_Bahdza, {{1559, 536}}, "only before completion of \"Destroy the Harpies\""},
    {GW::Constants::SkillID::Blinding_Surge, 03, "Moteh Thundershooter", GW::Constants::MapID::Wilderness_of_Bahdza, {{1391, 483}}},
    {GW::Constants::SkillID::Visions_of_Regret, 03, "Korrub, Flame of Dreams", GW::Constants::MapID::Wilderness_of_Bahdza, {{1409, 524}}, "only after completion of \"Destroy the Harpies\""},
    ...
    {GW::Constants::SkillID::Anthem_of_Guidance, 03, "General Kumtash", GW::Constants::MapID::Wilderness_of_Bahdza, {{1385, 421}}, "only during \"Dzagonur Bastion Mission\""},
    {GW::Constants::SkillID::Invoke_Lightning, 03, "General Tirraj", GW::Constants::MapID::Wilderness_of_Bahdza, {{1406, 375}}, "only during \"Dzagonur Bastion Mission\""},
    {GW::Constants::SkillID::Spell_Breaker, 03, "General Nimtak", GW::Constants::MapID::Wilderness_of_Bahdza, {{1398, 396}}, "only during \"Dzagonur Bastion Mission\""},
    {GW::Constants::SkillID::Magehunters_Smash, 03, "General Doriah", GW::Constants::MapID::Wilderness_of_Bahdza, {{1350, 430}}, "only during \"Dzagonur Bastion Mission\""},
    {GW::Constants::SkillID::Song_of_Restoration, 03, "Toshau Sharpspear", GW::Constants::MapID::Garden_of_Seborhin, {{496, 543}}, "not during the Mission"},
    {GW::Constants::SkillID::Air_of_Disenchantment, 03, "Hojanukun Mindstealer", GW::Constants::MapID::Garden_of_Seborhin, {{767, 397}}, "not during the Mission"},
    {GW::Constants::SkillID::Contagion, 03, "Mabah Heardheart", GW::Constants::MapID::Garden_of_Seborhin, {{664, 397}}, "not during the Mission"},
    {GW::Constants::SkillID::Word_of_Healing, 03, "Hahan, Faithful Protector", GW::Constants::MapID::Garden_of_Seborhin, {{444, 508}}, "not during the Mission"},
    {GW::Constants::SkillID::Zealous_Vow, 03, "Leilon, Tranquil Water", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1154, 123}}},
    {GW::Constants::SkillID::Searing_Flames, 03, "Kormab, Burning Heart", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1220, 214}}, "only during \"Dasha Vestibule Mission\""},
    {GW::Constants::SkillID::Vow_of_Silence, 03, "Water Lord", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1175, 22}}, "Only during the quest \"Gift of the Djinn\""},
    {GW::Constants::SkillID::Zealous_Vow, 03, "Hajok Earthguardian", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1220, 198}}, "only during \"Dasha Vestibule Mission\""},
    {GW::Constants::SkillID::Angelic_Bond, 03, "Shakor Firespear", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1219, 230}}, "only during \"Dasha Vestibule Mission\""},
    ...
    {GW::Constants::SkillID::Pain_of_Disenchantment, 03, "Nehpek the Remorseless", GW::Constants::MapID::Vehjin_Mines, {{117, 418}}, "do not spawn if you have Master of Whispers in your party and you have the quest Coffer of Joko active"},
    {GW::Constants::SkillID::Charge, 03, "Shak-Jarin the Justicebringer", GW::Constants::MapID::Vehjin_Mines, {{171, 434}}},
    {GW::Constants::SkillID::Soldiers_Stance, 04, "Avah the Crafty ", GW::Constants::MapID::The_Sulfurous_Wastes, {{952, 1127}}, "only during \"Gate of Desolation Mission\" \nSecond boss in the waves of undead"},
    {GW::Constants::SkillID::Soldiers_Fury, 04, "Chakeh the Lonely", GW::Constants::MapID::The_Sulfurous_Wastes, {{968, 1133}}, "only during \"Gate of Desolation Mission\" \nFirst boss in the waves of undead"},
    {GW::Constants::SkillID::Vow_of_Silence, 04, "Chundu the Meek", GW::Constants::MapID::The_Sulfurous_Wastes, {{973, 1154}}, "only during \"Gate of Desolation Mission\" \nThird boss in the waves of undead"},
    {GW::Constants::SkillID::Signet_of_Suffering, 04, "Nehmak the Unpleasant ", GW::Constants::MapID::The_Sulfurous_Wastes, {{953, 1142}}, "only during \"Gate of Desolation Mission\"\nSpawns in the last wave before riding the wurms. Spawns at the same time as Amind the Bitter"},
    {GW::Constants::SkillID::Hex_Eater_Vortex, 04, "Amind the Bitter", GW::Constants::MapID::The_Sulfurous_Wastes, {{955, 1156}}, "only during \"Gate of Desolation Mission\"\nSpawns in the last wave before riding the wurms. Spawns at the same time as Nehmak the Unpleasant"},
    ...
    {GW::Constants::SkillID::Magebane_Shot, 04, "Saushali the Frustrating", GW::Constants::MapID::The_Shattered_Ravines, {{1081, 310}}, "not if \"Horde of Darkness\" quest is active"},
    ...
    {GW::Constants::SkillID::Obsidian_Flesh, 04, "Shekoss the Stony", GW::Constants::MapID::Jokos_Domain, {{883, 658}}, "Shekoss will not spawn if A Deal's a Deal is active"},
    ...
    {GW::Constants::SkillID::Reapers_Mark, 01, "Midshipman Beraidun", GW::Constants::MapID::Cliffs_of_Dohjok, {{786, 545}}, "only during the quest A Land of Heroes"},
    {GW::Constants::SkillID::Vow_of_Strength, 01, "Ensign Jahan", GW::Constants::MapID::Cliffs_of_Dohjok, {{755, 572}}, "only during the quest A Land of Heroes"},
    {GW::Constants::SkillID::Crippling_Anthem, 01, "Lieutenant Mahrik", GW::Constants::MapID::Cliffs_of_Dohjok, {{645, 600}}, "only during the quest A Land of Heroes"},
    {GW::Constants::SkillID::Balthazars_Pendulum, 01, "Captain Shehnahr", GW::Constants::MapID::Cliffs_of_Dohjok, {{565, 572}}, "only during the quest A Land of Heroes"},
    ...
    {GW::Constants::SkillID::Junundu_Siege, 04, "Elder Wurms", GW::Constants::MapID::The_Shattered_Ravines, {{1097, 303}}, "This skill is acquired by following the primary quest received at the Bone Palace, \"Horde of Darkness.\" You must kill several Elder Wurms, which your wurm then consumes to learn the skill."},
    {GW::Constants::SkillID::Energy_Surge, 03, "Yammirvu, Ether Guardian", GW::Constants::MapID::The_Hidden_City_of_Ahdashim, {{1172, 38}}, "not during mission"},
    {GW::Constants::SkillID::Cruel_Spear, 02, "Eshau Longspear", GW::Constants::MapID::Sunspear_Sanctuary_outpost, {{568, 650}}, "Only during the quest Hunted!"},
    {GW::Constants::SkillID::Spell_Breaker, 03, "Preceptor Zunark", GW::Constants::MapID::Vehjin_Mines, {{255, 418}}, "during quest To The Rescue"},
    ...
    {GW::Constants::SkillID::Signet_of_Judgment, 05, "Rukkassa", GW::Constants::MapID::Nightfallen_Jahai, {{931, 135}}, "only during \"Invasion fromwithin\" quest"},
    ...
    {GW::Constants::SkillID::Hundred_Blades, 05, "Unknown", GW::Constants::MapID::Nightfallen_Jahai, {{706, 364}}, "only during \"Breaking the Broken\" quest"},
    ...
    {GW::Constants::SkillID::Ether_Prism, 05, "Tortureweb Dryder", GW::Constants::MapID::Domain_of_Pain, {{452, 778}}, "Capturable by all Tortureweb Dryders during mission"},
    {GW::Constants::SkillID::Invoke_Lightning, 05, "Curator Kali", GW::Constants::MapID::Depths_of_Madness, {{863, 1017}}, "only during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Magehunters_Smash, 05, "Champion Puran", GW::Constants::MapID::Depths_of_Madness, {{699, 1003}}, "only during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Spell_Breaker, 05, "Topo the Protector", GW::Constants::MapID::Depths_of_Madness, {{604, 924}}, "not during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Hundred_Blades, 05, "Reaper of Agony", GW::Constants::MapID::Depths_of_Madness, {{739, 963}}, "not during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Xinraes_Weapon, 05, "Consort of Ruin", GW::Constants::MapID::Depths_of_Madness, {{785, 1081}}, "not during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Golden_Skull_Strike, 05, "Ravager of Dreams", GW::Constants::MapID::Depths_of_Madness, {{714, 1155}}, "not during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Jagged_Bones, 05, "Master of Misery", GW::Constants::MapID::Depths_of_Madness, {{856, 1149}}, "not during \"Gate of Madness\" mission"},
    {GW::Constants::SkillID::Prepared_Shot, 05, "Seed of Suffering", GW::Constants::MapID::The_Shadow_Nexus, {{1506, 239}}},
    {GW::Constants::SkillID::Stunning_Strike, 05, "Shrieker of Dread", GW::Constants::MapID::The_Shadow_Nexus, {{1692, 122}}},
    {GW::Constants::SkillID::Mind_Freeze, 05, "Storm of Anguish", GW::Constants::MapID::The_Shadow_Nexus, {{1713, 170}}},
    {GW::Constants::SkillID::Defenders_Zeal, 05, "Flame of Fervor", GW::Constants::MapID::The_Shadow_Nexus, {{1734, 304}}},
    ...
    {GW::Constants::SkillID::Incendiary_Arrows, 05, "Stygian Underlord (Ranger)", GW::Constants::MapID::Domain_of_Anguish, {{1270, 1267}}, "This Stygian Underlord is a ranger found on the western hill of the five hills that dominate the Stygian Veil. Defeating it is one the final objectives of the quest Breaching the Stygian Veil.\nUnknown position"},
    {GW::Constants::SkillID::Anthem_of_Guidance, 05, "Lord Jadoth", GW::Constants::MapID::Domain_of_Anguish, {{1185, 1285}}, "Jadoth was a follower of Abaddon and the first Margonite. After receiving Abaddon's gift of magic, Jadoth became a great tactician and now rules over the City of Torc'qua in the Realm of Torment. He is one of the four \"overlords\", servants of Mallyx the Unyielding."},
    {GW::Constants::SkillID::Magehunters_Smash, 04, "Dupek the Mighty", GW::Constants::MapID::The_Sulfurous_Wastes, {{704, 1152}}, "Dupek the Mighty is a warrior boss that can be found in the Sulfurous Wastes, defending a shrine to Abaddon during the quest A Show of Force"},
    {GW::Constants::SkillID::Corrupt_Enchantment, 04, "Hauseh the Defiler", GW::Constants::MapID::The_Sulfurous_Wastes, {{704, 1167}}, "Hauseh the Defiler is a necromancer boss that can be found in The Sulfurous Wastes"},
    {GW::Constants::SkillID::Invoke_Lightning, 04, "Tanmahk the Arcane", GW::Constants::MapID::The_Sulfurous_Wastes, {{690, 1158}}, "Tanmahk the Arcane is a elementalist boss that can be found in The Sulfurous Wastes during the quest A Show of Force"},
    ...
    {GW::Constants::SkillID::Expel_Hexes, 01, "Jin, the Purifier", GW::Constants::MapID::Bukdek_Byway, {{531, 371}}, "Won't spawn when the quest \"Chasing Zenmai\" is active"},
    ...
    {GW::Constants::SkillID::Palm_Strike, 01, "Kenshi Steelhand", GW::Constants::MapID::Bukdek_Byway, {{544, 399}}, "If the quest Eliminate the Jade Brotherhood is active, Kenshi will spawn twice at the same location - one to the southeast of Oroku, one to the southerwest. His normal spawn point is to the southwest, but the quest spawns another copy to the southeast at the same time.\nKenshi will not spawn if the Chasing Zenmai quest is active."},
    ...
    {GW::Constants::SkillID::Double_Dragon, 01, "Lian, Dragon's Petal", GW::Constants::MapID::Wajjun_Bazaar, {{303, 535}}, "She will not be there if you have the quest Closer to the Stars and are supposed to talk to Fishmonger Bihzun for the first time"},
    {GW::Constants::SkillID::Word_of_Censure, 01, "Quufu", GW::Constants::MapID::Wajjun_Bazaar, {{172, 465}}, "only during the Straight to the Top quest"},
    {GW::Constants::SkillID::Quivering_Blade, 01, "Sun, the Quivering", GW::Constants::MapID::Wajjun_Bazaar, {{359, 615}}, "The Am Fah must be your enemy in order to encounter Sun, the Quivering. If they are your allies you must do the quest Seek out Brother Tosai and complete either the Drink from the Chalice of Corruption quest or the Refuse to Drink quest"},
    {GW::Constants::SkillID::Ray_of_Judgment, 01, "The Afflicted Miju", GW::Constants::MapID::The_Undercity, {{235, 189}}, "It will not spawn if you have quest \"The Shadow Blades\" listed"},
    {GW::Constants::SkillID::Martyr, 01, "Am Fah Leader", GW::Constants::MapID::The_Undercity, {{267, 333}}, "only during the quest \"Capturing the Orrian Tome\""},
    ...
    {GW::Constants::SkillID::Shatter_Storm, 01, "Mina Shatter Storm", GW::Constants::MapID::The_Undercity, {{225, 331}}},
    ...
    {GW::Constants::SkillID::Flashing_Blades, 01, "Waeng", GW::Constants::MapID::The_Undercity, {{132, 307}}, "during the quest Assist the Guards"},
    {GW::Constants::SkillID::Enraged_Smash, 01, "The Afflicted Ako", GW::Constants::MapID::Vizunah_Square_mission, {{635, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Broad_Head_Arrow, 01, "The Afflicted Huan ", GW::Constants::MapID::Vizunah_Square_mission, {{651, 417}}, "during \"Vizunah Square\" mission\nIt doesn't always appear"},
    {GW::Constants::SkillID::Ray_of_Judgment, 01, "The Afflicted Miju", GW::Constants::MapID::Vizunah_Square_mission, {{667, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Order_of_Apostasy, 01, "The Afflicted Thu", GW::Constants::MapID::Vizunah_Square_mission, {{683, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Stolen_Speed, 01, "The Afflicted Li Yun", GW::Constants::MapID::Vizunah_Square_mission, {{699, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Mind_Burn, 01, "The Afflicted Kam", GW::Constants::MapID::Vizunah_Square_mission, {{715, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Shadow_Form, 01, "The Afflicted Soon Kim", GW::Constants::MapID::Vizunah_Square_mission, {{731, 417}}, "during \"Vizunah Square\" mission"},
    {GW::Constants::SkillID::Weapon_of_Quickening, 01, "The Afflicted Hakaru", GW::Constants::MapID::Vizunah_Square_mission, {{747, 417}}, "during \"Vizunah Square\" mission"},
    ...
    {GW::Constants::SkillID::Enraged_Lunge, 01, "Royen Beastkeeper", GW::Constants::MapID::Nahpui_Quarter_outpost_mission, {{533, 870}}, "not during the mission"},
    ...
    {GW::Constants::SkillID::Auspicious_Parry, 01, "Bound Jaizhanju", GW::Constants::MapID::Tahnnakai_Temple_outpost_mission, {{991, 555}}, "only during \"Tahnnakai Temple\" mission\\m Fifth boss encountered"},
    ...
    {GW::Constants::SkillID::Wanderlust, 01, "Quansong Spiritspeak", GW::Constants::MapID::Tahnnakai_Temple_outpost_mission, {{994, 413}}, "If you have the quest A Meeting With the Emperor he will not spawn"},
    ...
    {GW::Constants::SkillID::Hundred_Blades, 01, "Warrior's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{968, 742}}, "not during \"Sunjiang District\" mission"},
    {GW::Constants::SkillID::Equinox, 01, "Ranger's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1002, 853}}, "not during \"Sunjiang District\" mission"},
    {GW::Constants::SkillID::Life_Sheath, 01, "Monk's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1029, 724}}, "not during \"Sunjiang District\" mission"},
    {GW::Constants::SkillID::Soul_Bind, 01, "Necromancer's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1012, 804}}, "not during \"Sunjiang District\" mission"},
    {GW::Constants::SkillID::Psychic_Distraction, 01, "Mesmer's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1034, 778}}, "not during \"Sunjiang District\" mission\nin the same room of the final attack of the mission"},
    {GW::Constants::SkillID::Mirror_of_Ice, 01, "Elemental's Construct", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1062, 777}}, "not during \"Sunjiang District\" mission\n"},
    ...
    {GW::Constants::SkillID::Auspicious_Parry, 01, "Sword Ancient Kai", GW::Constants::MapID::Raisu_Palace, {{592, 166}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Famine, 01, "Famished Ancient Brrne", GW::Constants::MapID::Raisu_Palace, {{682, 168}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Spell_Breaker, 01, "Untouched Ancient Ky", GW::Constants::MapID::Raisu_Palace, {{842, 148}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Wail_of_Doom, 01, "Doomed Ancient Kkraz", GW::Constants::MapID::Raisu_Palace, {{652, 164}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Arcane_Languor, 01, "Arcane Ancient Phi", GW::Constants::MapID::Raisu_Palace, {{842, 165}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Star_Burst, 01, "Star Ancient Koosun", GW::Constants::MapID::Raisu_Palace, {{708, 163}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Shroud_of_Silence, 01, "Silent Ancient Onata", GW::Constants::MapID::Raisu_Palace, {{842, 182}}, "only during \"Raisu Palace\" mission"},
    {GW::Constants::SkillID::Defiant_Was_Xinrae, 01, "Defiant Ancient Sseer", GW::Constants::MapID::Raisu_Palace, {{824, 123}}, "only during \"Raisu Palace\" mission"},
    ...
    {GW::Constants::SkillID::Seven_Weapon_Stance, 01, "Blade Ancient Syu-Shai", GW::Constants::MapID::Raisu_Palace, {{743, 165}}, "not during \"Raisu Palace\" mission, only if a player has a \"Proof of Triumph\" in their inventory"},
    {GW::Constants::SkillID::Weapons_of_Three_Forges, 01, "Blade Ancient Syu-Shai", GW::Constants::MapID::Raisu_Palace, {{755, 165}}, "not during \"Raisu Palace\" mission, only if a player has a \"Proof of Triumph\" in their inventory"},
    {GW::Constants::SkillID::Shadow_Theft, 01, "Blade Ancient Syu-Shai", GW::Constants::MapID::Raisu_Palace, {{767, 165}}, "not during \"Raisu Palace\" mission, only if a player has a \"Proof of Triumph\" in their inventory"},
    ...
    {GW::Constants::SkillID::Forceful_Blow, 02, "Mahr Stonebreaker", GW::Constants::MapID::Arborstone_outpost_mission, {{201, 223}}, "not during \"Arborstone\" mission"},
    {GW::Constants::SkillID::Lacerate, 02, "Ryver Mossplanter", GW::Constants::MapID::Arborstone_outpost_mission, {{186, 286}}, "not during \"Arborstone\" mission\nHe will NOT appear if you have the Song and Stone quest"},
    {GW::Constants::SkillID::Shield_of_Regeneration, 02, "Meril Stoneweaver", GW::Constants::MapID::Arborstone_outpost_mission, {{119, 301}}, "not during \"Arborstone\" mission"},
    {GW::Constants::SkillID::Vampiric_Spirit, 02, "Kaswa Webstrider", GW::Constants::MapID::Arborstone_outpost_mission, {{60, 284}}, "not during \"Arborstone\" mission"},
    {GW::Constants::SkillID::Lingering_Curse, 02, "Craw Stonereap", GW::Constants::MapID::Arborstone_outpost_mission, {{165, 334}}, "not during \"Arborstone\" mission"},
    {GW::Constants::SkillID::Shockwave, 02, "Zarnas Stonewrath", GW::Constants::MapID::Arborstone_outpost_mission, {{136, 330}}, "not during \"Arborstone\" mission"},
    ...
    {GW::Constants::SkillID::Boon_Signet, 02, "Mungri Magicbox", GW::Constants::MapID::Ferndale, {{425, 430}}, "patrolling this area"},
    ...
    {GW::Constants::SkillID::Beguiling_Haze, 02, "Warden of Saprophytes", GW::Constants::MapID::Ferndale, {{324, 556}}, "if all members of the party have completed the quest \"Temple of the Dredge\", this boss will not appear"},
    {GW::Constants::SkillID::Aura_of_Displacement, 02, "Maximole", GW::Constants::MapID::Ferndale, {{397, 460}}, "only during the quest \"Revolt of the Dredge\"\npatrolling this area"},
    ...
    {GW::Constants::SkillID::Archers_Signet, 02, "Nundak The Archer", GW::Constants::MapID::Melandrus_Hope, {{689, 734}}, "He patrols south, west to the river and then back again\nHe is together with Rot Foulbelly"},
    {GW::Constants::SkillID::Weaken_Knees, 02, "Rot Foulbelly", GW::Constants::MapID::Melandrus_Hope, {{705, 734}}, "He patrols south, west to the river and then back again\nHe is together with Nundak The Archer"},
    ...
    {GW::Constants::SkillID::Enraged_Smash, 02, "The Afflicted Maaka", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{440, 1013}}, "one of the bosses assaulting during \"The Eternal Grove\" Mission"},
    {GW::Constants::SkillID::Shadow_Form, 02, "The Afflicted Senku", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{440, 1028}}, "one of the bosses assaulting during \"The Eternal Grove\" Mission"},
    {GW::Constants::SkillID::Weapon_of_Quickening, 02, "The Afflicted Xenxo", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{440, 1043}}, "one of the bosses assaulting during \"The Eternal Grove\" Mission"},
    {GW::Constants::SkillID::Devastating_Hammer, 02, "Tembarr Treefall", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{230, 1075}}},
    {GW::Constants::SkillID::Healing_Burst, 02, "The Scar Eater", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{500, 1111}}},
    {GW::Constants::SkillID::Air_of_Enchantment, 02, "Jayne Forestlight", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{401, 1066}}},
    {GW::Constants::SkillID::Echo, 02, "The Time Eater", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{419, 1103}}},
    {GW::Constants::SkillID::Shatterstone, 02, "Wiseroot Shatterstone", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{546, 1133}}},
    {GW::Constants::SkillID::Moebius_Strike, 02, "Bramble Everthorn", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{395, 1010}}},
    {GW::Constants::SkillID::Preservation, 02, "Flower Spiritgarden", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{423, 1137}}},
    {GW::Constants::SkillID::Ritual_Lord, 02, "Spiritroot Mossbeard", GW::Constants::MapID::The_Eternal_Grove_outpost_mission, {{309, 1127}}},
    ...
    {GW::Constants::SkillID::Beguiling_Haze, 02, "Falaharn Mistwarden", GW::Constants::MapID::Morostav_Trail, {{859, 1097}}, "Falaharn Mistwarden only appears when a character approaches his location"},
    ...
    {GW::Constants::SkillID::Gust, 02, "Rahse Windcatcher", GW::Constants::MapID::Mourning_Veil_Falls, {{392, 1285}, {721, 1224}}, "Can spawn outside of Durheim Archives or Amatz Basin"},
    ...
    {GW::Constants::SkillID::Whirling_Axe, 03, "Geoffer Pain Bringer", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{424, 152}}, "not during \"Boreas Seabed\" Mission\nHe wont appear when the quest Protect the Halcyon is taken by one of your party members."},
    {GW::Constants::SkillID::Dragon_Slash, 03, "Sskai, Dragon's Birth", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{503, 75}}, "not during \"Boreas Seabed\" Mission"},
    {GW::Constants::SkillID::Ferocious_Strike, 03, "Milodestus the Wrangler", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{522, 156}}, "not during \"Boreas Seabed\" Mission"},
    {GW::Constants::SkillID::Way_of_the_Empty_Palm, 03, "Ilidus of the Empty Palm", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{542, 28}}, "not during \"Boreas Seabed\" Mission\nDuring The Halcyon Job quest, this boss does not spawn; however, Senkai, Lord of the 1,000 Daggers Guild spawns at his location, and has the same elite skill."},
    {GW::Constants::SkillID::Way_of_the_Empty_Palm, 03, "Senkai, Lord of the 1,000 Daggers Guild", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{530, 28}}, "not during \"Boreas Seabed\" Mission\nDuring the quest The Halcyon Job"},
    ...
    {GW::Constants::SkillID::Discord, 03, "Xiriss Stickleback", GW::Constants::MapID::Archipelagos, {{575, 448}}, "Only during the quest Night Raiders"},
    ...
    {GW::Constants::SkillID::Escape, 03, "Stsou Swiftscale", GW::Constants::MapID::Maishang_Hills, {{743, 271}}, "if you entered Maishang Hills having the Attack the Kurzicks quest, neither him nor any of the normal enemies around Gyala Hatchery will appear"},
    ...
    {GW::Constants::SkillID::Siphon_Strength, 03, "Ssaresh Rattler", GW::Constants::MapID::Maishang_Hills, {{580, 195}}, "This boss won't appear during Stolen Eggs quest"},
    {GW::Constants::SkillID::Coward, 03, "Kayali the Brave", GW::Constants::MapID::Mount_Qinkai, {{268, 300}}},
    {GW::Constants::SkillID::Battle_Rage, 03, "Arrahhsh Mountainclub", GW::Constants::MapID::Mount_Qinkai, {{92, 203}}, "only during the quest \"Return of the Yeti\""},
    ...
    {GW::Constants::SkillID::Primal_Rage, 03, "Reefclaw Ragebound", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{787, 590}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Charge, 03, "Jacqui The Reaver", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{751, 542}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Tainted_Flesh, 03, "Lukrker Foulfist", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{891, 403}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Echo, 03, "Mohby Windbeak", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{786, 512}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Shockwave, 03, "Bahnba Shockfoot", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{844, 465}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Obsidian_Flesh, 03, "Whyk Steelshell", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{728, 528}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Beguiling_Haze, 03, "Razorfang Hazeclaw", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{880, 469}}, "not during \"Gyala Hatchery\" mission"},
    {GW::Constants::SkillID::Preservation, 03, "Soulwhisper, Elder Guardian", GW::Constants::MapID::Gyala_Hatchery_outpost_mission, {{761, 618}}, "not during \"Gyala Hatchery\" mission"},
    ...
    {GW::Constants::SkillID::Shatterstone, 03, "Wavecrest Stonebreak", GW::Constants::MapID::Rheas_Crater, {{1030, 742}}, "Wavecrest is quite mobile and wanders around the eastern perimeter of Rhea's Crater once you go near his spawn point. It's group sometimes gets attacked by other monsters, but usually wins the fight."},
    {GW::Constants::SkillID::Dark_Apostasy, 03, "Arius, Dark Apostle", GW::Constants::MapID::Rheas_Crater, {{975, 673}}, "Depending on where you entered, Arius could have already been killed by other mobs by the time you reach her location. However, it's still possible to capture the skill if that's what you're after"},
    ...
    {GW::Constants::SkillID::Air_of_Enchantment, 03, "Miella Lightwing", GW::Constants::MapID::Silent_Surf, {{812, 981}}, "in patrol in the area just outside Unwaking Waters (Luxon)"},
    ...
    {GW::Constants::SkillID::Gust, 03, "Amadis, Wind of the Sea", GW::Constants::MapID::Silent_Surf, {{818, 902}}, "187 patrolling off the southern coast of the middle island. If players choose to follow him, he will get into fight with several groups of jade fish (during his patrol) and will be killed when he is nearly back to the starting point"},
    {GW::Constants::SkillID::Temple_Strike, 03, "Assassin's Construct", GW::Constants::MapID::Silent_Surf, {{830, 847}}},
    {GW::Constants::SkillID::Ritual_Lord, 03, "Whispering Ritual Lord", GW::Constants::MapID::Silent_Surf, {{868, 953}}, "He does not spawn if you have the quest The Dragon Hunter active in your log\nHe makes a small rotation south of where the map indicates"},
    {GW::Constants::SkillID::Broad_Head_Arrow, 03, "The Afflicted Pana", GW::Constants::MapID::Unwaking_Waters, {{632, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Order_of_Apostasy, 03, "The Afflicted Lau", GW::Constants::MapID::Unwaking_Waters, {{618, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Stolen_Speed, 03, "The Afflicted Hsin Jun", GW::Constants::MapID::Unwaking_Waters, {{603, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Mind_Burn, 03, "The Afflicted Shen", GW::Constants::MapID::Unwaking_Waters, {{588, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Shadow_Form, 03, "The Afflicted Senku", GW::Constants::MapID::Unwaking_Waters, {{572, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Weapon_of_Quickening, 03, "The Afflicted Xenxo", GW::Constants::MapID::Unwaking_Waters, {{557, 968}}, "only during \"Unwaking Water\" MIssion\nOne of the attacking Afflicted"},
    {GW::Constants::SkillID::Charge, 03, "Merki The Reaver", GW::Constants::MapID::Unwaking_Waters, {{664, 994}}, "not during \"Unwaking Water\" MIssion"},
    {GW::Constants::SkillID::Cultists_Fervor, 03, "Cultist Rajazan", GW::Constants::MapID::Unwaking_Waters, {{526, 1047}}, "not during \"Unwaking Water\" MIssion"},
    {GW::Constants::SkillID::Psychic_Instability, 03, "Chazek Plague Herder", GW::Constants::MapID::Unwaking_Waters, {{586, 1026}}, "not during \"Unwaking Water\" MIssion"},
    {GW::Constants::SkillID::Ride_the_Lightning, 03, "Kunvie Firewing", GW::Constants::MapID::Unwaking_Waters, {{553, 1020}}, "not during \"Unwaking Water\" MIssion"},
    {GW::Constants::SkillID::Shadow_Shroud, 03, "Shrouded Oni", GW::Constants::MapID::Unwaking_Waters, {{578, 1083}}, "not during \"Unwaking Water\" MIssion"},
    ...
    {GW::Constants::SkillID::Shadow_Form, 01, "The Afflicted Soon Kim", GW::Constants::MapID::Sunjiang_District_outpost_mission, {{1091, 718}}, "does not spawn if the Count's Daughter quest is active"},
    {GW::Constants::SkillID::Mark_of_Protection, 01, "Kepkhet Marrowfeast", GW::Constants::MapID::Prophets_Path, {{359, 1088}}},
    {GW::Constants::SkillID::Marksmans_Wager, 01, "Custodian Kora", GW::Constants::MapID::Dunes_of_Despair, {{135, 1537}}, "One of the bosses found at the end of the mission"},
    {GW::Constants::SkillID::Word_of_Healing, 01, "Dassk Arossyss", GW::Constants::MapID::Dunes_of_Despair, {{106, 1533}}, "One of the bosses found at the end of the mission"},
    {GW::Constants::SkillID::Order_of_the_Vampire, 01, "Byssha Hisst", GW::Constants::MapID::Dunes_of_Despair, {{156, 1536}}, "One of the bosses found at the end of the mission"},
    {GW::Constants::SkillID::Ether_Renewal, 01, "Cyss Gresshla", GW::Constants::MapID::Dunes_of_Despair, {{103, 1558}}, "One of the bosses found at the end of the mission"},
    ...
    {GW::Constants::SkillID::Warriors_Endurance, 01, "Custodian Dellus", GW::Constants::MapID::Elona_Reach, {{386, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Mantra_of_Recovery, 01, "Tiss Danssir", GW::Constants::MapID::Elona_Reach, {{400, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Marksmans_Wager, 01, "Custodian Jenus", GW::Constants::MapID::Elona_Reach, {{414, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Word_of_Healing, 01, "Wissper Inssani", GW::Constants::MapID::Elona_Reach, {{428, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Order_of_the_Vampire, 01, "Uussh Visshta", GW::Constants::MapID::Elona_Reach, {{442, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Ether_Renewal, 01, "Vassa Ssiss", GW::Constants::MapID::Elona_Reach, {{456, 739}}, "spawns in one of the six locations marked by a red cross"},
    {GW::Constants::SkillID::Crippling_Anguish, 01, "Yxthoshth", GW::Constants::MapID::Salt_Flats, {{354, 540}}, "only during quest \"The Ranger's Path\""},
    ...
    {GW::Constants::SkillID::Offering_of_Blood, 02, "Tonfor Copperblood", GW::Constants::MapID::Lornars_Pass, {{45, 308}, {201, 444}}, "He shares two spawn locations with two other bosses and regular Pinesouls, so he may not be there."},
    {GW::Constants::SkillID::Defy_Pain, 02, "Clobberhusk", GW::Constants::MapID::Lornars_Pass, {{97, 447}, {109, 64}, {199, 61}}},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Erzek Runebreaker", GW::Constants::MapID::Lornars_Pass, {{57, 308}, {213, 444}}, "He shares two spawn locations with two other bosses and regular Pinesouls, so he may not be there."},
    {GW::Constants::SkillID::Water_Trident, 02, "Chunk Clumpfoot", GW::Constants::MapID::Lornars_Pass, {{69, 308}, {207, 456}}, "He shares two spawn locations with two other bosses and regular Pinesouls, so he may not be there."},
    ...
    {GW::Constants::SkillID::Dwarven_Battle_Stance, 02, "Thorgall Bludgeonhammer", GW::Constants::MapID::Grenths_Footprint, {{219, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    {GW::Constants::SkillID::Melandrus_Arrows, 02, "Gargash Thornbeard", GW::Constants::MapID::Grenths_Footprint, {{236, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    {GW::Constants::SkillID::Mark_of_Protection, 02, "Wroth Yakslapper", GW::Constants::MapID::Grenths_Footprint, {{253, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    {GW::Constants::SkillID::Offering_of_Blood, 02, "Morgriff Shadestone", GW::Constants::MapID::Grenths_Footprint, {{270, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Gorrel Rockmolder", GW::Constants::MapID::Grenths_Footprint, {{287, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    {GW::Constants::SkillID::Water_Trident, 02, "Flint Fleshcleaver", GW::Constants::MapID::Grenths_Footprint, {{304, 1102}}, "Spawns in one of the 10 spots, marked by a red cross"},
    ...
    {GW::Constants::SkillID::Victory_Is_Mine, 02, "Jono Yawpyawl", GW::Constants::MapID::Talus_Chute, {{247, 1401}, {325, 1410}, {385, 1418}, {421, 1532}}, "It shares 4 spawn locations with 4 other bosses so It may not be present"},
    {GW::Constants::SkillID::Poison_Arrow, 02, "Kekona Pippip", GW::Constants::MapID::Talus_Chute, {{259, 1401}, {337, 1410}, {397, 1418}, {433, 1532}}, "It shares 4 spawn locations with 4 other bosses so It may not be present"},
    {GW::Constants::SkillID::Plague_Signet, 02, "Allobo Dimdim", GW::Constants::MapID::Talus_Chute, {{259, 1413}, {337, 1422}, {397, 1430}, {433, 1544}}, "It shares 4 spawn locations with 4 other bosses so It may not be present"},
    {GW::Constants::SkillID::Glimmering_Mark, 02, "Edibbo Pekpek", GW::Constants::MapID::Talus_Chute, {{247, 1413}, {325, 1422}, {385, 1430}, {421, 1544}}, "It shares 4 spawn locations with 4 other bosses so It may not be present"},
    {GW::Constants::SkillID::Signet_of_Judgment, 02, "Frostbite", GW::Constants::MapID::Talus_Chute, {{199, 1431}, {211, 1472}, {277, 1464}}, "He shares three spawn locations with three other bosses, so he may not be there"},
    {GW::Constants::SkillID::Mist_Form, 02, "Brrrr Windburn", GW::Constants::MapID::Talus_Chute, {{211, 1431}, {223, 1472}, {289, 1464}}, "He shares three spawn locations with three other bosses, so he may not be there"},
    {GW::Constants::SkillID::Illusionary_Weaponry, 02, "Seear Windlash", GW::Constants::MapID::Talus_Chute, {{211, 1443}, {223, 1484}, {289, 1476}}, "He shares three spawn locations with three other bosses, so he may not be there"},
    {GW::Constants::SkillID::Spiteful_Spirit, 02, "Nighh SpineChill", GW::Constants::MapID::Talus_Chute, {{199, 1443}, {211, 1484}, {277, 1476}}, "He shares three spawn locations with three other bosses, so he may not be there"},
    ...
    {GW::Constants::SkillID::Unyielding_Aura, 02, "Ipillo Wupwup", GW::Constants::MapID::Witmans_Folly, {{567, 1767}, {601, 1746}, {656, 1730}, {653, 1774}}, "He shares four spawn locations with four other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Victory_Is_Mine, 02, "Sakalo Yawpyawl", GW::Constants::MapID::Witmans_Folly, {{579, 1767}, {613, 1746}, {668, 1730}, {665, 1774}}, "He shares four spawn locations with four other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Poison_Arrow, 02, "Salani Pippip", GW::Constants::MapID::Witmans_Folly, {{567, 1779}, {601, 1758}, {653, 1786}, {656, 1742}}, "He shares four spawn locations with four other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Glimmering_Mark, 02, "Alana Pekpek", GW::Constants::MapID::Witmans_Folly, {{579, 1779}, {613, 1758}, {665, 1786}, {668, 1742}}, "He shares four spawn locations with four other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Plague_Signet, 02, "Karobo Dimdim", GW::Constants::MapID::Witmans_Folly, {{573, 1791}, {607, 1770}, {660, 1798}}, "He shares four spawn locations with four other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Plague_Signet, 02, "Karobo Dimdim", GW::Constants::MapID::Witmans_Folly, {{662, 1754}}, "He shares four spawn locationswith four other bosses, so he may not always appear"},
    ...
    {GW::Constants::SkillID::Thunderclap, 02, "Mursaat Elementalist", GW::Constants::MapID::Ice_Floe, {{1018, 1556}, {969, 1509}, {1132, 1421}, {1178, 1407}}, "Despite being nameless, he is a boss\nHe shares four spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Aura_of_Faith, 02, "Mursaat Monk ", GW::Constants::MapID::Ice_Floe, {{1166, 1407}, {1120, 1421}}, "Despite being nameless, he is a boss\nHe shares four spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Cleave, 02, "Gornar Bellybreaker", GW::Constants::MapID::Thunderhead_Keep, {{1355, 1306}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Cleave, 02, "Gornar Bellybreaker", GW::Constants::MapID::Thunderhead_Keep, {{1362, 1241}}, "He shares two spawn locations with five other bosses, so he may not always  appear"},
    {GW::Constants::SkillID::Devastating_Hammer, 02, "Perfected Armor", GW::Constants::MapID::Thunderhead_Keep, {{1360, 1167}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Oath_Shot, 02, "Perfected Cloak", GW::Constants::MapID::Thunderhead_Keep, {{1348, 1167}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Aura_of_Faith, 02, "Demetrios the Enduring", GW::Constants::MapID::Thunderhead_Keep, {{1372, 1167}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Life_Transfer, 02, "Argyris the Scoundrel", GW::Constants::MapID::Thunderhead_Keep, {{1348, 1179}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Thunderclap, 02, "Chrysos the Magnetic", GW::Constants::MapID::Thunderhead_Keep, {{1360, 1179}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Energy_Surge, 02, "Panthar The Deceiver", GW::Constants::MapID::Thunderhead_Keep, {{1372, 1179}}, "During the siege. He may not appear"},
    {GW::Constants::SkillID::Melandrus_Arrows, 02, "Ulhar Stonehound", GW::Constants::MapID::Thunderhead_Keep, {{1350, 1241}, {1343, 1306}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Mark_of_Protection, 02, "Bolis Hillshaker", GW::Constants::MapID::Thunderhead_Keep, {{1374, 1241}, {1367, 1306}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Offering_of_Blood, 02, "Riine Windrot", GW::Constants::MapID::Thunderhead_Keep, {{1350, 1253}, {1343, 1318}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Fuury Stonewrath", GW::Constants::MapID::Thunderhead_Keep, {{1362, 1253}, {1355, 1318}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Water_Trident, 02, "The Judge", GW::Constants::MapID::Thunderhead_Keep, {{1374, 1253}, {1367, 1318}}, "He shares two spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Water_Trident, 02, "Boreal Kubeclaw", GW::Constants::MapID::Frozen_Forest, {{783, 1375}, {813, 1301}, {784, 1260}, {861, 1308}, {944, 1322}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Cleave, 02, "Linka Goldensteel", GW::Constants::MapID::Frozen_Forest, {{795, 1375}, {825, 1301}, {796, 1260}, {873, 1308}, {956, 1322}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Melandrus_Arrows, 02, "Resnar Mountainsight", GW::Constants::MapID::Frozen_Forest, {{771, 1375}, {801, 1301}, {772, 1260}, {849, 1308}, {932, 1322}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Barl Stormsiege", GW::Constants::MapID::Frozen_Forest, {{801, 1313}, {771, 1387}, {772, 1272}, {849, 1320}, {932, 1334}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Offering_of_Blood, 02, "Jollen Steelblight", GW::Constants::MapID::Frozen_Forest, {{783, 1387}, {861, 1320}, {944, 1334}, {813, 1313}, {784, 1272}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Mark_of_Protection, 02, "Mesqul Ironhealer", GW::Constants::MapID::Frozen_Forest, {{795, 1387}, {873, 1320}, {956, 1334}, {825, 1313}, {796, 1272}}, "He shares five spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Grenths_Balance, 02, "Mragga", GW::Constants::MapID::Frozen_Forest, {{773, 1197}}, "only during the quest The Hero's Challenge"},
    ...
    {GW::Constants::SkillID::Cleave, 02, "Marika Granitehand", GW::Constants::MapID::Iron_Mines_of_Moladune, {{994, 997}, {1017, 1035}}, "He shares two spawn locations with two other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Mark_of_Protection, 02, "Lokar Icemender", GW::Constants::MapID::Iron_Mines_of_Moladune, {{1006, 997}, {1029, 1035}}, "He shares two spawn locations with two other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Dwarven_Battle_Stance, 02, "Slonak Copperbark", GW::Constants::MapID::Iron_Mines_of_Moladune, {{1000, 1009}, {1023, 1047}}, "He shares two spawn locations with two other bosses, so he may not always appear"},
    ...
    {GW::Constants::SkillID::Signet_of_Judgment, 02, "Balt Duskstrider", GW::Constants::MapID::Iron_Mines_of_Moladune, {{1031, 753}, {983, 845}}, "He shares two spawn locations with two other bosses, so he may not be there"},
    {GW::Constants::SkillID::Spiteful_Spirit, 02, "Ceru Gloomrunner", GW::Constants::MapID::Iron_Mines_of_Moladune, {{1043, 753}, {995, 845}}, "He shares two spawn locations with two other bosses, so he may not be there"},
    {GW::Constants::SkillID::Illusionary_Weaponry, 02, "Digo Murkstalker", GW::Constants::MapID::Iron_Mines_of_Moladune, {{1037, 765}, {989, 857}}, "He shares two spawn locations with two other bosses, so he may not be there"},
    ...
    {GW::Constants::SkillID::Victory_Is_Mine, 02, "Jono Yawpyawl", GW::Constants::MapID::Spearhead_Peak, {{502, 1050}, {624, 1059}, {688, 1060}, {666, 1101}}, "He shares four spawn locations with four other bosses, so he may not be there"},
    {GW::Constants::SkillID::Glimmering_Mark, 02, "Edibbo Pekpek", GW::Constants::MapID::Spearhead_Peak, {{514, 1050}, {636, 1059}, {700, 1060}, {678, 1101}}, "He shares four spawn locations with four other bosses, so he may not be there"},
    {GW::Constants::SkillID::Plague_Signet, 02, "Allobo Dimdim", GW::Constants::MapID::Spearhead_Peak, {{526, 1050}, {648, 1059}, {712, 1060}, {690, 1101}}, "He shares four spawn locations with four other bosses, so he may not be there"},
    {GW::Constants::SkillID::Unyielding_Aura, 02, "Kaia Wupwup", GW::Constants::MapID::Spearhead_Peak, {{509, 1062}, {630, 1071}, {694, 1072}, {673, 1113}}, "He shares four spawn locations with four other bosses, so he may not be there"},
    {GW::Constants::SkillID::Poison_Arrow, 02, "Kekona Pippip", GW::Constants::MapID::Spearhead_Peak, {{685, 1113}, {706, 1072}, {642, 1071}, {521, 1062}}, "He shares four spawn locations with four other bosses, so he may not be there"},
    ...
    {GW::Constants::SkillID::Flourish, 02, "Syr Honorcrest", GW::Constants::MapID::Mineral_Springs, {{628, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Practiced_Stance, 02, "Ryk Arrowwing", GW::Constants::MapID::Mineral_Springs, {{643, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Shield_of_Judgment, 02, "Myd Springclaw", GW::Constants::MapID::Mineral_Springs, {{658, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Well_of_Power, 02, "Nhy Darkclaw", GW::Constants::MapID::Mineral_Springs, {{673, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Ineptitude, 02, "Wyt Sharpfeather", GW::Constants::MapID::Mineral_Springs, {{688, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Glyph_of_Energy, 02, "Hyl Thunderwing", GW::Constants::MapID::Mineral_Springs, {{703, 574}}, "Spawns in one of the possible locations, marked by a red cross"},
    {GW::Constants::SkillID::Mist_Form, 02, "Ice Beast", GW::Constants::MapID::Mineral_Springs, {{1015, 668}}},
    {GW::Constants::SkillID::Charge, 03, "Balthazaar's Cursed", GW::Constants::MapID::Perdition_Rock, {{764, 408}, {827, 439}, {887, 339}, {885, 275}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Charge, 03, "Balthazaar's Cursed", GW::Constants::MapID::Perdition_Rock, {{790, 233}}},
    {GW::Constants::SkillID::Crippling_Shot, 03, "Melandru's Cursed", GW::Constants::MapID::Perdition_Rock, {{752, 408}, {815, 439}, {875, 339}, {873, 275}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Crippling_Shot, 03, "Melandru's Cursed", GW::Constants::MapID::Perdition_Rock, {{778, 233}}},
    {GW::Constants::SkillID::Amity, 03, "Pravus Obsideo", GW::Constants::MapID::Perdition_Rock, {{776, 408}, {839, 439}, {899, 339}, {897, 275}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Amity, 03, "Pravus Obsideo", GW::Constants::MapID::Perdition_Rock, {{802, 233}}},
    {GW::Constants::SkillID::Power_Block, 03, "Lyssa's Cursed", GW::Constants::MapID::Perdition_Rock, {{752, 396}, {815, 427}, {875, 327}, {873, 263}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Power_Block, 03, "Lyssa's Cursed", GW::Constants::MapID::Perdition_Rock, {{778, 221}}},
    {GW::Constants::SkillID::Signet_of_Midnight, 03, "Malus Phasmatis", GW::Constants::MapID::Perdition_Rock, {{764, 396}, {827, 427}, {887, 327}, {885, 263}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Signet_of_Midnight, 03, "Malus Phasmatis", GW::Constants::MapID::Perdition_Rock, {{790, 221}}},
    {GW::Constants::SkillID::Wither, 03, "Ignis Effigia", GW::Constants::MapID::Perdition_Rock, {{776, 396}, {839, 427}, {899, 327}, {897, 263}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Wither, 03, "Ignis Effigia", GW::Constants::MapID::Perdition_Rock, {{802, 221}}},
    {GW::Constants::SkillID::Lingering_Curse, 03, "Grenth's Cursed", GW::Constants::MapID::Perdition_Rock, {{758, 420}, {821, 451}, {881, 351}, {879, 287}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Lingering_Curse, 03, "Grenth's Cursed", GW::Constants::MapID::Perdition_Rock, {{784, 245}}},
    {GW::Constants::SkillID::Martyr, 03, "Dwayna's Cursed", GW::Constants::MapID::Perdition_Rock, {{770, 420}, {833, 451}, {893, 351}, {891, 287}}, "Two bosses can spawn in this location"},
    {GW::Constants::SkillID::Martyr, 03, "Dwayna's Cursed", GW::Constants::MapID::Perdition_Rock, {{796, 245}}},
    {GW::Constants::SkillID::Bulls_Charge, 03, "Skintekaru Manshredder", GW::Constants::MapID::Perdition_Rock, {{654, 294}, {714, 311}, {806, 269}}},
    {GW::Constants::SkillID::Elemental_Attunement, 03, "Geckokaru Earthwind", GW::Constants::MapID::Perdition_Rock, {{666, 294}, {726, 311}, {818, 269}}},
    {GW::Constants::SkillID::Tainted_Flesh, 03, "Dosakaru Fevertouch", GW::Constants::MapID::Perdition_Rock, {{660, 306}, {720, 323}, {812, 281}}},
    {GW::Constants::SkillID::Healing_Hands, 03, "Rull Browbeater", GW::Constants::MapID::Perdition_Rock, {{636, 326}, {644, 399}, {683, 325}, {872, 420}}, "Four locations for three bosses, so no one could spawn here"},
    {GW::Constants::SkillID::Echo, 03, "Rwek Khawl Mawl", GW::Constants::MapID::Perdition_Rock, {{648, 326}, {695, 325}, {656, 399}, {884, 420}}, "Four locations for three bosses, so no one could spawn here"},
    {GW::Constants::SkillID::Glyph_of_Renewal, 03, "Nayl Klaw Tuthan", GW::Constants::MapID::Perdition_Rock, {{642, 338}, {689, 337}, {650, 411}, {878, 432}}, "Four locations for three bosses, so no one could spawn here"},
    {GW::Constants::SkillID::Obsidian_Flesh, 03, "Harn Coldstone", GW::Constants::MapID::Perdition_Rock, {{828, 315}}, "This is the point from which he starts patrolling, as soon as you see him. He will patrol all the east side of the island"},
    {GW::Constants::SkillID::Quick_Shot, 03, "Maxine Coldstone", GW::Constants::MapID::Perdition_Rock, {{840, 315}}, "This is the point from which he starts patrolling, as soon as you see him. He will patrol all the east side of the island"},
    ...
    {GW::Constants::SkillID::Oath_Shot, 03, "Cairn the Relentless", GW::Constants::MapID::Abaddons_Mouth, {{321, 328}, {260, 254}, {210, 274}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Devastating_Hammer, 03, "Cairn the Destroyer", GW::Constants::MapID::Abaddons_Mouth, {{309, 328}, {248, 254}, {198, 274}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Thunderclap, 03, "Optimus Caliph", GW::Constants::MapID::Abaddons_Mouth, {{297, 328}, {236, 254}, {186, 274}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Aura_of_Faith, 03, "Willa the Unpleasant", GW::Constants::MapID::Abaddons_Mouth, {{321, 340}, {260, 266}, {210, 286}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Energy_Surge, 03, "Mercia the Smug", GW::Constants::MapID::Abaddons_Mouth, {{309, 340}, {198, 286}, {248, 266}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Life_Transfer, 03, "Sarlic the Judge", GW::Constants::MapID::Abaddons_Mouth, {{297, 340}, {236, 266}, {186, 286}}, "Two bosses at time spawn in this location"},
    {GW::Constants::SkillID::Fevered_Dreams, 03, "Plexus Shadowhook", GW::Constants::MapID::Abaddons_Mouth, {{70, 243}, {86, 166}, {208, 168}}, "There is a chance that this boss may not spawn, leaving just an ordinary Dark Flame Dryder in its place"},
    {GW::Constants::SkillID::Restore_Condition, 03, "Spindle Agonyvein", GW::Constants::MapID::Abaddons_Mouth, {{82, 243}, {98, 166}, {220, 168}}, "There is a chance that this boss may not spawn, leaving just an ordinary Dark Flame Dryder in its place"},
    {GW::Constants::SkillID::Soul_Leech, 03, "Goss Darkweb", GW::Constants::MapID::Abaddons_Mouth, {{76, 255}, {92, 178}, {214, 180}}, "There is a chance that this boss may not spawn, leaving just an ordinary Dark Flame Dryder in its place"},
    {GW::Constants::SkillID::Barrage, 03, "Snyk the Hundred Tongue", GW::Constants::MapID::Abaddons_Mouth, {{61, 276}, {66, 312}}, "He is not a guaranteed spawn and will not always be there"},
    {GW::Constants::SkillID::Mist_Form, 03, "Eidolon", GW::Constants::MapID::Abaddons_Mouth, {{54, 259}}},
    {GW::Constants::SkillID::Oath_Shot, 03, "Cairn the Troubling", GW::Constants::MapID::Ring_of_Fire, {{505, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Devastating_Hammer, 03, "Cairn the Smug", GW::Constants::MapID::Ring_of_Fire, {{521, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Energy_Surge, 03, "Melek the Virtuous", GW::Constants::MapID::Ring_of_Fire, {{537, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Thunderclap, 03, "Maida the Ill Tempered", GW::Constants::MapID::Ring_of_Fire, {{553, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Life_Transfer, 03, "Odelyn the Displeased", GW::Constants::MapID::Ring_of_Fire, {{569, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Aura_of_Faith, 03, "Coventina the Matron", GW::Constants::MapID::Ring_of_Fire, {{585, 211}}, "Can spawn in one out the six locations, marked with a red cross"},
    {GW::Constants::SkillID::Backbreaker, 03, "Ferk Mallet", GW::Constants::MapID::Ring_of_Fire, {{623, 57}}, "Sometimes, He may not spawn at all"},
    {GW::Constants::SkillID::Backbreaker, 03, "Ferk Mallet", GW::Constants::MapID::Ring_of_Fire, {{638, 91}}, "Sometimes, He may not spawn at all\nusually start moving as soon as a player comes into radar range and may ambush players from behind when they are moving forward on the regular mission path"},
    {GW::Constants::SkillID::Spike_Trap, 03, "Vulg Painbrain", GW::Constants::MapID::Ring_of_Fire, {{650, 91}}, "Sometimes, He may not spawn at all\nusually start moving as soon as a player comes into radar range and may ambush players from behind when they are moving forward on the regular mission path"},
    {GW::Constants::SkillID::Spike_Trap, 03, "Vulg Painbrain", GW::Constants::MapID::Ring_of_Fire, {{635, 57}}, "Sometimes, He may not spawn at all"},
    {GW::Constants::SkillID::Incendiary_Arrows, 03, "Casses Flameweb", GW::Constants::MapID::Ring_of_Fire, {{458, 95}, {501, 58}}, "Does not always appear"},
    ...
    {GW::Constants::SkillID::Mist_Form, 03, "Eidolon", GW::Constants::MapID::Ring_of_Fire, {{449, 129}}, "appears once the Ether Seals are defeated"},
    ...
    {GW::Constants::SkillID::Mark_of_Protection, 02, "Ivor Helmhewer", GW::Constants::MapID::Sorrows_Furnace, {{332, 860}}, "during The Final Assault / The Forge Heart at the Iron Arch"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Vokur Grimshackles", GW::Constants::MapID::Sorrows_Furnace, {{377, 860}}, "during Orozar Highstone's quests, in one of 6 random boss spawn locations\nin the Gap, near Marshall Whitman\nin Sorrow's Belly"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Garbok Handsmasher", GW::Constants::MapID::Sorrows_Furnace, {{392, 860}}, "in Sorrow's Belly"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Hierophant Morlog", GW::Constants::MapID::Sorrows_Furnace, {{347, 860}}, "only if the quest \"Unspeakable, Unknowable, High Priest Alkar\" is taken"},
    {GW::Constants::SkillID::Crippling_Anguish, 02, "Korvald Willcrusher", GW::Constants::MapID::Sorrows_Furnace, {{362, 860}}, "during Noble Intentions while defending Orozar Highstone\nduring Noble Intentions Plan B after lowering the bridge\nduring Final Assault / The Forge Heart at the Iron Arch"},
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 1", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{598, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total. Each of them drops a few of the Hall of Heroes unique items"},
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 2", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{621, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total. Each of them drops a few of the Hall of Heroes unique items"},
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 3", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{644, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total. Each of them drops a few of the Hall of Heroes unique items"},
    {GW::Constants::SkillID::Unyielding_Aura, 02, "Kaia Wupwup", GW::Constants::MapID::Talus_Chute, {{271, 1407}, {349, 1416}, {409, 1424}, {445, 1538}}, "It shares 4 spawn locations with 4 other bosses so It may not be present"},
    {GW::Constants::SkillID::Wither, 07, "Desnas Hubor", GW::Constants::MapID::Tangle_Root, {{1098, 957}}, "only during the quest \"Defend Denravi\""},
    ...
    {GW::Constants::SkillID::Wither, 02, "Evirso Sectus", GW::Constants::MapID::Mineral_Springs, {{987, 722}}, "only during the quest \"Defend Droknar's Forge\""},
    {GW::Constants::SkillID::Warriors_Endurance, 01, "Custodian Fidius", GW::Constants::MapID::Dunes_of_Despair, {{120, 1535}}, "only during the Mission. He is one of the last boss, met during the mission"},
    {GW::Constants::SkillID::Aura_of_Faith, 02, "Mursaat Monk", GW::Constants::MapID::Ice_Floe, {{1006, 1556}, {957, 1509}}, "Despite being nameless, he is a boss\nHe shares four spawn locations with five other bosses, so he may not always appear"},
    {GW::Constants::SkillID::Devastating_Hammer, 02, "Jade Armor", GW::Constants::MapID::Ice_Floe, {{945, 1509}, {994, 1556}, {1108, 1421}, {1154, 1407}}, "Despite being nameless, he is a boss\nHe shares four spawn locations with five other bosses, so he may not always appear"},
