...
const EliteBossLocation elite_boss_locations[] = {
    ...
    {GW::Constants::SkillID::Skull_Crack, 01, "Lann Browsmasher", GW::Constants::MapID::Drakkar_Lake, {{743, 548}}, "Can also spawn in the south of the lake."},
    {GW::Constants::SkillID::Skull_Crack, 01, "Lann Browsmasher", GW::Constants::MapID::Drakkar_Lake, {{869, 669}}, "Can also spawn in the cave."},
    ...
    {GW::Constants::SkillID::Life_Transfer, 01, "Tanto the Grim", GW::Constants::MapID::Varajar_Fells, {{923, 1026}}, "Only during \"Haunted\" quest."},
    ...
    {GW::Constants::SkillID::Barrage, 02, "Groknar Weazlewortz", GW::Constants::MapID::Grothmar_Wardowns, {{404, 283}}, "During \"Against the Charr\" mission - at the Supply Caravan."},
    {GW::Constants::SkillID::Eviscerate, 02, "Gordam Griefgiver", GW::Constants::MapID::Grothmar_Wardowns, {{440, 322}}, "During \"Against the Charr\" mission."},
    {GW::Constants::SkillID::Ward_Against_Harm, 02, "Frazar Frostfur", GW::Constants::MapID::Grothmar_Wardowns, {{450, 425}}, "During \"Against the Charr\" mission."},
    ...
    {GW::Constants::SkillID::Power_Block, 02, "Anmat the Trickster", GW::Constants::MapID::Sacnoth_Valley, {{426, 322}}, "During \"Against the Charr\" mission."},
    ...
    {GW::Constants::SkillID::Barrage, 02, "Commander Kubeh", GW::Constants::MapID::Arkjok_Ward, {{824, 1045}}, "Only during \"The Great Escape\" quest. Three times."},
    {GW::Constants::SkillID::Depravity, 02, "Modti Darkflower", GW::Constants::MapID::Arkjok_Ward, {{753, 1051}}},
    {GW::Constants::SkillID::Enchanters_Conundrum, 02, "Captain Chichor", GW::Constants::MapID::Arkjok_Ward, {{812, 1005}}, "Patrols the three islands counterclockwise.\nNot during \"The Great Escape\" quest."},
    ...
    {GW::Constants::SkillID::Sandstorm, 02, "The Drought", GW::Constants::MapID::The_Floodplain_of_Mahnkelon, {{1351, 519}}, "Only during \"Rilohn Refuge\" mission."},
    ...
    {GW::Constants::SkillID::Magehunter_Strike, 02, "Captain Kavaka", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{907, 1345}}, "Only during \"Consulate Docks\" mission."},
    {GW::Constants::SkillID::Master_of_Magic, 02, "Captain Mwende", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{883, 1352}}, "Only during \"Consulate Docks\" mission."},
    {GW::Constants::SkillID::Cautery_Signet, 02, "Captain Lumanda", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{790, 1351}}, "Only during \"Consulate Docks\" mission."},
    {GW::Constants::SkillID::Pious_Renewal, 02, "Captain Denduru", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{822, 1344}}, "Only during \"Consulate Docks\" mission."},
    {GW::Constants::SkillID::Magehunter_Strike, 02, "Executioner Vekil", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{900, 1218}}, "Only during \"Pogahn Passage\" mission."},
    {GW::Constants::SkillID::Enchanters_Conundrum, 02, "Lieutenant Nali", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{906, 1328}}, "Only during \"Pogahn Passage\" mission."},
    {GW::Constants::SkillID::Master_of_Magic, 02, "Captain Nebo", GW::Constants::MapID::Gandara_the_Moon_Fortress, {{823, 1366}}, "Only during \"Pogahn Passage\" mission."},
    ...
    {GW::Constants::SkillID::Ether_Prism, 05, "Tortureweb Dryder", GW::Constants::MapID::Domain_of_Pain, {{452, 778}}, "Only during \"Gate of Pain\" mission. Six times."},
    ...
    {GW::Constants::SkillID::Enraged_Lunge, 01, "Royen Beastkeeper", GW::Constants::MapID::Nahpui_Quarter_outpost_mission, {{533, 870}}, "Not during \"Nahpui Quarter\" mission."},
    ...
    {GW::Constants::SkillID::Wanderlust, 01, "Quansong Spiritspeak", GW::Constants::MapID::Tahnnakai_Temple_outpost_mission, {{994, 413}}, "Not during \"A Meeting With the Emperor\" quest."},
    ...
    {GW::Constants::SkillID::Lacerate, 02, "Ryver Mossplanter", GW::Constants::MapID::Arborstone_outpost_mission, {{186, 286}}, "Not during \"Arborstone\" mission and \"Song and Stone\" quest."},
    ...
    {GW::Constants::SkillID::Whirling_Axe, 03, "Geoffer Pain Bringer", GW::Constants::MapID::Boreas_Seabed_outpost_mission, {{424, 152}}, "Not during \"Boreas Seabed\" mission and \"Protect the Halcyon\" quest."},
    ...
    {GW::Constants::SkillID::Broad_Head_Arrow, 03, "The Afflicted Pana", GW::Constants::MapID::Unwaking_Waters, {{632, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    {GW::Constants::SkillID::Order_of_Apostasy, 03, "The Afflicted Lau", GW::Constants::MapID::Unwaking_Waters, {{618, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    {GW::Constants::SkillID::Stolen_Speed, 03, "The Afflicted Hsin Jun", GW::Constants::MapID::Unwaking_Waters, {{603, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    {GW::Constants::SkillID::Mind_Burn, 03, "The Afflicted Shen", GW::Constants::MapID::Unwaking_Waters, {{588, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    {GW::Constants::SkillID::Shadow_Form, 03, "The Afflicted Senku", GW::Constants::MapID::Unwaking_Waters, {{572, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    {GW::Constants::SkillID::Weapon_of_Quickening, 03, "The Afflicted Xenxo", GW::Constants::MapID::Unwaking_Waters, {{557, 968}}, "Only during \"Unwaking Waters\" mission.\nOne of the attacking Afflicted."},
    ...
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 1", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{598, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total."},
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 2", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{621, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total."},
    {GW::Constants::SkillID::Energy_Surge, 01, "The Darkness 3", GW::Constants::MapID::Tomb_of_the_Primeval_Kings, {{644, 112}}, "These are the final bosses of the Ruins of the Tomb of the Primeval Kings. There are three in total."},
