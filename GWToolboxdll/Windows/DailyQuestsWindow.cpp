...
namespace {
    ...
    // Copper Zaishen Coin rewards by quest ID, values are {nm_coins, hm_coins}.
    // Data sourced from the Guild Wars wiki (Game_link:Quest_<id>).
    // Run tools/generate_zaishen_coins.py to regenerate from the wiki.
    const std::unordered_map<QuestID, DailyQuests::ZaishenCoinReward> zaishen_coin_rewards = {
        // Zaishen Mission - Prophecies
        {QuestID::ZaishenMission_The_Great_Northern_Wall,   {1, 2}},
        {QuestID::ZaishenMission_Fort_Ranik,                {1, 2}},
        {QuestID::ZaishenMission_Ruins_of_Surmia,           {1, 2}},
        {QuestID::ZaishenMission_Nolani_Academy,            {1, 2}},
        {QuestID::ZaishenMission_Borlis_Pass,               {1, 2}},
        {QuestID::ZaishenMission_The_Frost_Gate,            {1, 2}},
        {QuestID::ZaishenMission_Gates_of_Kryta,            {1, 2}},
        {QuestID::ZaishenMission_DAlessio_Seaboard,         {1, 2}},
        {QuestID::ZaishenMission_Divinity_Coast,            {1, 2}},
        {QuestID::ZaishenMission_The_Wilds,                 {1, 2}},
        {QuestID::ZaishenMission_Bloodstone_Fen,            {1, 2}},
        {QuestID::ZaishenMission_Aurora_Glade,              {1, 2}},
        {QuestID::ZaishenMission_Riverside_Province,        {1, 2}},
        {QuestID::ZaishenMission_Sanctum_Cay,               {1, 2}},
        {QuestID::ZaishenMission_Dunes_of_Despair,          {1, 2}},
        {QuestID::ZaishenMission_Thirsty_River,             {1, 2}},
        {QuestID::ZaishenMission_Elona_Reach,               {1, 2}},
        {QuestID::ZaishenMission_Augury_Rock,               {1, 2}},
        {QuestID::ZaishenMission_The_Dragons_Lair,          {1, 2}},
        {QuestID::ZaishenMission_Ice_Caves_of_Sorrow,       {1, 2}},
        {QuestID::ZaishenMission_Iron_Mines_of_Moladune,    {1, 2}},
        {QuestID::ZaishenMission_Thunderhead_Keep,          {1, 2}},
        {QuestID::ZaishenMission_Ring_of_Fire,              {1, 2}},
        {QuestID::ZaishenMission_Abaddons_Mouth,            {1, 2}},
        {QuestID::ZaishenMission_Hells_Precipice,           {1, 2}},

        // Zaishen Mission - Factions
        {QuestID::ZaishenMission_Zen_Daijun,                {1, 2}},
        {QuestID::ZaishenMission_Vizunah_Square,            {1, 2}},
        {QuestID::ZaishenMission_Nahpui_Quarter,            {1, 2}},
        {QuestID::ZaishenMission_Tahnnakai_Temple,          {1, 2}},
        {QuestID::ZaishenMission_Arborstone,                {1, 2}},
        {QuestID::ZaishenMission_Boreas_Seabed,             {1, 2}},
        {QuestID::ZaishenMission_Sunjiang_District,         {1, 2}},
        {QuestID::ZaishenMission_The_Eternal_Grove,         {1, 2}},
        {QuestID::ZaishenMission_Unwaking_Waters,           {1, 2}},
        {QuestID::ZaishenMission_Gyala_Hatchery,            {1, 2}},
        {QuestID::ZaishenMission_Raisu_Palace,              {1, 2}},
        {QuestID::ZaishenMission_Imperial_Sanctum,          {1, 2}},
        {QuestID::ZaishenMission_Minister_Chos_Estate,      {1, 2}},

        // Zaishen Mission - Nightfall
        {QuestID::ZaishenMission_Chahbek_Village,           {1, 2}},
        {QuestID::ZaishenMission_Jokanur_Diggings,          {1, 2}},
        {QuestID::ZaishenMission_Blacktide_Den,             {1, 2}},
        {QuestID::ZaishenMission_Consulate_Docks,           {1, 2}},
        {QuestID::ZaishenMission_Venta_Cemetery,            {1, 2}},
        {QuestID::ZaishenMission_Kodonur_Crossroads,        {1, 2}},
        {QuestID::ZaishenMission_Pogahn_Passage,            {1, 2}},
        {QuestID::ZaishenMission_Rilohn_Refuge,             {1, 2}},
        {QuestID::ZaishenMission_Moddok_Crevice,            {1, 2}},
        {QuestID::ZaishenMission_Tihark_Orchard,            {1, 2}},
        {QuestID::ZaishenMission_Dzagonur_Bastion,          {1, 2}},
        {QuestID::ZaishenMission_Dasha_Vestibule,           {1, 2}},
        {QuestID::ZaishenMission_Grand_Court_of_Sebelkeh,   {1, 2}},
        {QuestID::ZaishenMission_Jennurs_Horde,             {1, 2}},
        {QuestID::ZaishenMission_Nundu_Bay,                 {1, 2}},
        {QuestID::ZaishenMission_Gate_of_Desolation,        {1, 2}},
        {QuestID::ZaishenMission_Ruins_of_Morah,            {1, 2}},
        {QuestID::ZaishenMission_Gate_of_Pain,              {1, 2}},
        {QuestID::ZaishenMission_Gate_of_Madness,           {1, 2}},
        {QuestID::ZaishenMission_Abaddons_Gate,             {1, 2}},

        // Zaishen Mission - Eye of the North
        {QuestID::ZaishenMission_Finding_the_Bloodstone,    {1, 2}},
        {QuestID::ZaishenMission_The_Elusive_Golemancer,    {1, 2}},
        {QuestID::ZaishenMission_G_O_L_E_M,                 {1, 2}},
        {QuestID::ZaishenMission_Against_the_Charr,         {1, 2}},
        {QuestID::ZaishenMission_Warband_of_Brothers,       {1, 2}},
        {QuestID::ZaishenMission_Assault_on_the_Stronghold, {1, 2}},
        {QuestID::ZaishenMission_Curse_of_the_Nornbear,     {1, 2}},
        {QuestID::ZaishenMission_Blood_Washes_Blood,        {1, 2}},
        {QuestID::ZaishenMission_A_Gate_Too_Far,            {1, 2}},
        {QuestID::ZaishenMission_Destructions_Depths,       {1, 2}},
        {QuestID::ZaishenMission_A_Time_for_Heroes,         {1, 2}},

        // Zaishen Bounty
        {QuestID::ZaishenBounty_Urgoz,                      {1, 2}},
        {QuestID::ZaishenBounty_Chung_The_Attuned,          {1, 2}},
        {QuestID::ZaishenBounty_Mungri_Magicbox,            {1, 2}},
        {QuestID::ZaishenBounty_The_Stygian_Lords,          {1, 2}},
        {QuestID::ZaishenBounty_Ilsundur_Lord_of_Fire,      {1, 2}},
        {QuestID::ZaishenBounty_Rragar_Maneater,            {1, 2}},
        {QuestID::ZaishenBounty_Murakai_Lady_of_the_Night,  {1, 2}},
        {QuestID::ZaishenBounty_Prismatic_Ooze,             {1, 2}},
        {QuestID::ZaishenBounty_Havok_Soulwail,             {1, 2}},
        {QuestID::ZaishenBounty_Frostmaw_the_Kinslayer,     {1, 2}},
        {QuestID::ZaishenBounty_Remnant_of_Antiquities,     {1, 2}},
        {QuestID::ZaishenBounty_Plague_of_Destruction,      {1, 2}},
        {QuestID::ZaishenBounty_Zoldark_the_Unholy,         {1, 2}},
        {QuestID::ZaishenBounty_Khabuus,                    {1, 2}},
        {QuestID::ZaishenBounty_Zhim_Monns,                 {1, 2}},
        {QuestID::ZaishenBounty_Eldritch_Ettin,             {1, 2}},
        {QuestID::ZaishenBounty_Fendi_Nin,                  {1, 2}},
        {QuestID::ZaishenBounty_TPS_Regulator_Golem,        {1, 2}},
        {QuestID::ZaishenBounty_Arachni,                    {1, 2}},
        {QuestID::ZaishenBounty_Forgewight,                 {1, 2}},
        {QuestID::ZaishenBounty_Selvetarm,                  {1, 2}},
        {QuestID::ZaishenBounty_Justiciar_Thommis,          {1, 2}},
        {QuestID::ZaishenBounty_Rand_Stormweaver,           {1, 2}},
        {QuestID::ZaishenBounty_Duncan_the_Black,           {1, 2}},
        {QuestID::ZaishenBounty_Fronis_Irontoe,             {1, 2}},
        {QuestID::ZaishenBounty_Magmus,                     {1, 2}},
        {QuestID::ZaishenBounty_Lord_Khobay,                {1, 2}},

        // Zaishen Vanquish
        {QuestID::ZaishenVanquish_Dejarin_Estate,                   {1, 2}},
        {QuestID::ZaishenVanquish_Watchtower_Coast,                  {1, 2}},
        {QuestID::ZaishenVanquish_Arbor_Bay,                         {1, 2}},
        {QuestID::ZaishenVanquish_Barbarous_Shore,                   {1, 2}},
        {QuestID::ZaishenVanquish_Deldrimor_Bowl,                    {1, 2}},
        {QuestID::ZaishenVanquish_Boreas_Seabed,                     {1, 2}},
        {QuestID::ZaishenVanquish_Cliffs_of_Dohjok,                  {1, 2}},
        {QuestID::ZaishenVanquish_Diessa_Lowlands,                   {1, 2}},
        {QuestID::ZaishenVanquish_Bukdek_Byway,                      {1, 2}},
        {QuestID::ZaishenVanquish_Bjora_Marches,                     {1, 2}},
        {QuestID::ZaishenVanquish_Crystal_Overlook,                  {1, 2}},
        {QuestID::ZaishenVanquish_Diviners_Ascent,                   {1, 2}},
        {QuestID::ZaishenVanquish_Dalada_Uplands,                    {1, 2}},
        {QuestID::ZaishenVanquish_Drazach_Thicket,                   {1, 2}},
        {QuestID::ZaishenVanquish_Fahranur_the_First_City,           {1, 2}},
        {QuestID::ZaishenVanquish_Dragons_Gullet,                    {1, 2}},
        {QuestID::ZaishenVanquish_Ferndale,                          {1, 2}},
        {QuestID::ZaishenVanquish_Forum_Highlands,                   {1, 2}},
        {QuestID::ZaishenVanquish_Dreadnoughts_Drift,                {1, 2}},
        {QuestID::ZaishenVanquish_Drakkar_Lake,                      {1, 2}},
        {QuestID::ZaishenVanquish_Dry_Top,                           {1, 2}},
        {QuestID::ZaishenVanquish_Tears_of_the_Fallen,               {1, 2}},
        {QuestID::ZaishenVanquish_Gyala_Hatchery,                    {1, 2}},
        {QuestID::ZaishenVanquish_Ettins_Back,                       {1, 2}},
        {QuestID::ZaishenVanquish_Gandara_the_Moon_Fortress,         {1, 2}},
        {QuestID::ZaishenVanquish_Grothmar_Wardowns,                 {1, 2}},
        {QuestID::ZaishenVanquish_Flame_Temple_Corridor,             {1, 2}},
        {QuestID::ZaishenVanquish_Haiju_Lagoon,                      {1, 2}},
        {QuestID::ZaishenVanquish_Frozen_Forest,                     {1, 2}},
        {QuestID::ZaishenVanquish_Garden_of_Seborhin,                {1, 2}},
        {QuestID::ZaishenVanquish_Grenths_Footprint,                 {1, 2}},
        {QuestID::ZaishenVanquish_Jaya_Bluffs,                       {1, 2}},
        {QuestID::ZaishenVanquish_Holdings_of_Chokhin,               {1, 2}},
        {QuestID::ZaishenVanquish_Ice_Cliff_Chasms,                  {1, 2}},
        {QuestID::ZaishenVanquish_Griffons_Mouth,                    {1, 2}},
        {QuestID::ZaishenVanquish_Kinya_Province,                    {1, 2}},
        {QuestID::ZaishenVanquish_Issnur_Isles,                      {1, 2}},
        {QuestID::ZaishenVanquish_Jaga_Moraine,                      {1, 2}},
        {QuestID::ZaishenVanquish_Ice_Floe,                          {1, 2}},
        {QuestID::ZaishenVanquish_Maishang_Hills,                    {1, 2}},
        {QuestID::ZaishenVanquish_Jahai_Bluffs,                      {1, 2}},
        {QuestID::ZaishenVanquish_Riven_Earth,                       {1, 2}},
        {QuestID::ZaishenVanquish_Icedome,                           {1, 2}},
        {QuestID::ZaishenVanquish_Minister_Chos_Estate,              {1, 2}},
        {QuestID::ZaishenVanquish_Mehtani_Keys,                      {1, 2}},
        {QuestID::ZaishenVanquish_Sacnoth_Valley,                    {1, 2}},
        {QuestID::ZaishenVanquish_Iron_Horse_Mine,                   {1, 2}},
        {QuestID::ZaishenVanquish_Morostav_Trail,                    {1, 2}},
        {QuestID::ZaishenVanquish_Plains_of_Jarin,                   {1, 2}},
        {QuestID::ZaishenVanquish_Sparkfly_Swamp,                    {1, 2}},
        {QuestID::ZaishenVanquish_Kessex_Peak,                       {1, 2}},
        {QuestID::ZaishenVanquish_Mourning_Veil_Falls,               {1, 2}},
        {QuestID::ZaishenVanquish_The_Alkali_Pan,                    {1, 2}},
        {QuestID::ZaishenVanquish_Varajar_Fells,                     {1, 2}},
        {QuestID::ZaishenVanquish_Lornars_Pass,                      {1, 2}},
        {QuestID::ZaishenVanquish_Pongmei_Valley,                    {1, 2}},
        {QuestID::ZaishenVanquish_The_Floodplain_of_Mahnkelon,       {1, 2}},
        {QuestID::ZaishenVanquish_Verdant_Cascades,                  {1, 2}},
        {QuestID::ZaishenVanquish_Majestys_Rest,                     {1, 2}},
        {QuestID::ZaishenVanquish_Raisu_Palace,                      {1, 2}},
        {QuestID::ZaishenVanquish_The_Hidden_City_of_Ahdashim,       {1, 2}},
        {QuestID::ZaishenVanquish_Rheas_Crater,                      {1, 2}},
        {QuestID::ZaishenVanquish_Mamnoon_Lagoon,                    {1, 2}},
        {QuestID::ZaishenVanquish_Shadows_Passage,                   {1, 2}},
        {QuestID::ZaishenVanquish_The_Mirror_of_Lyss,                {1, 2}},
        {QuestID::ZaishenVanquish_Saoshang_Trail,                    {1, 2}},
        {QuestID::ZaishenVanquish_Nebo_Terrace,                      {1, 2}},
        {QuestID::ZaishenVanquish_Shenzun_Tunnels,                   {1, 2}},
        {QuestID::ZaishenVanquish_The_Ruptured_Heart,                {1, 2}},
        {QuestID::ZaishenVanquish_Salt_Flats,                        {1, 2}},
        {QuestID::ZaishenVanquish_North_Kryta_Province,              {1, 2}},
        {QuestID::ZaishenVanquish_Silent_Surf,                       {1, 2}},
        {QuestID::ZaishenVanquish_The_Shattered_Ravines,             {1, 2}},
        {QuestID::ZaishenVanquish_Scoundrels_Rise,                   {1, 2}},
        {QuestID::ZaishenVanquish_Old_Ascalon,                       {1, 2}},
        {QuestID::ZaishenVanquish_Sunjiang_District,                 {1, 2}},
        {QuestID::ZaishenVanquish_The_Sulphurous_Wastes,             {1, 2}},
        {QuestID::ZaishenVanquish_Magus_Stones,                      {1, 2}},
        {QuestID::ZaishenVanquish_Perdition_Rock,                    {1, 2}},
        {QuestID::ZaishenVanquish_Sunqua_Vale,                       {1, 2}},
        {QuestID::ZaishenVanquish_Turais_Procession,                 {1, 2}},
        {QuestID::ZaishenVanquish_Norrhart_Domains,                  {1, 2}},
        {QuestID::ZaishenVanquish_Pockmark_Flats,                    {1, 2}},
        {QuestID::ZaishenVanquish_Tahnnakai_Temple,                  {1, 2}},
        {QuestID::ZaishenVanquish_Vehjin_Mines,                      {1, 2}},
        {QuestID::ZaishenVanquish_Poisoned_Outcrops,                 {1, 2}},
        {QuestID::ZaishenVanquish_Prophets_Path,                     {1, 2}},
        {QuestID::ZaishenVanquish_The_Eternal_Grove,                 {1, 2}},
        {QuestID::ZaishenVanquish_Tascas_Demise,                     {1, 2}},
        {QuestID::ZaishenVanquish_Respendent_Makuun,                 {1, 2}},
        {QuestID::ZaishenVanquish_Reed_Bog,                          {1, 2}},
        {QuestID::ZaishenVanquish_Unwaking_Waters,                   {1, 2}},
        {QuestID::ZaishenVanquish_Stingray_Strand,                   {1, 2}},
        {QuestID::ZaishenVanquish_Sunward_Marches,                   {1, 2}},
        {QuestID::ZaishenVanquish_Regent_Valley,                     {1, 2}},
        {QuestID::ZaishenVanquish_Wajjun_Bazaar,                     {1, 2}},
        {QuestID::ZaishenVanquish_Yatendi_Canyons,                   {1, 2}},
        {QuestID::ZaishenVanquish_Twin_Serpent_Lakes,                {1, 2}},
        {QuestID::ZaishenVanquish_Sage_Lands,                        {1, 2}},
        {QuestID::ZaishenVanquish_Xaquang_Skyway,                    {1, 2}},
        {QuestID::ZaishenVanquish_Zehlon_Reach,                      {1, 2}},
        {QuestID::ZaishenVanquish_Tangle_Root,                       {1, 2}},
        {QuestID::ZaishenVanquish_Silverwood,                        {1, 2}},
        {QuestID::ZaishenVanquish_Zen_Daijun,                        {1, 2}},
        {QuestID::ZaishenVanquish_The_Arid_Sea,                      {1, 2}},
        {QuestID::ZaishenVanquish_Nahpui_Quarter,                    {1, 2}},
        {QuestID::ZaishenVanquish_Skyward_Reach,                     {1, 2}},
        {QuestID::ZaishenVanquish_The_Scar,                          {1, 2}},
        {QuestID::ZaishenVanquish_The_Black_Curtain,                 {1, 2}},
        {QuestID::ZaishenVanquish_Panjiang_Peninsula,                {1, 2}},
        {QuestID::ZaishenVanquish_Snake_Dance,                       {1, 2}},
        {QuestID::ZaishenVanquish_Travelers_Vale,                    {1, 2}},
        {QuestID::ZaishenVanquish_The_Breach,                        {1, 2}},
        {QuestID::ZaishenVanquish_Lahtenda_Bog,                      {1, 2}},
        {QuestID::ZaishenVanquish_Spearhead_Peak,                    {1, 2}},
    };
