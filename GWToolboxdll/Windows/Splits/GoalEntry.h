...
struct GoalEntry {
    ...
    bool           starts_immediately = false; // start_real_time = 0 when the run is attached (fires at t=0) — never serialized, only valid the same tick a preset is built off a live signal
