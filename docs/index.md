...
> Note: we released a new launcher, you can download it <a href="{{ site.github.releases_url }}/download/2.14_Release/GWToolbox.exe">here</a>). The new launcher will update the dll automatically.
