...
> Note: we released a new launcher, you can download it [here](https://github.com/3vcloud/GWToolboxpp/releases/download/2.27-1.8.94_Release/JonsToolbox.exe). The new launcher will update the dll automatically.
