...
- **Pcons**: The "Pcons" button allows you to toggle specific [Pcons](/docs/pcons/) on or off when you load the build. When the Pcons button is greyed out, it won't change your pcons when you load the build. You can also send the list of Pcons for a build to chat.
