...
Toolbox includes several features that interact with the game's camera, allowing you to view the world from different perspectives. All camera functions can be accessed via [chat commands](/docs/commands/).
