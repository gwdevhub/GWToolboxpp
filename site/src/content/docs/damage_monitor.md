...
You can customize the color of the bars in [Settings](/docs/settings/). You can also adjust the row height to make the monitor line up better with your party window.
