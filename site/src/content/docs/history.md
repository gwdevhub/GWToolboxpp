...
* [Minor] Bonds: the Heroic Refrain checkbox in the bond monitor's settings now has a help tooltip explaining that refrains can only be shown on yourself and your own heroes — Guild Wars doesn't tell your client about refrains you maintain on other players, so they can't be displayed.
