...
Each of these individual components can be removed in [Settings](/docs/settings/).
...
This function is also available as a [chat command](/docs/commands/) or a [hotkey](/docs/hotkeys/).
