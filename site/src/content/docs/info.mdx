...
<figure>
<img src="/docs-images/28233535-5b479466-68ac-11e7-910a-a58a3d755578.webp"/>
<figcaption>Info Window</figcaption>
</figure>

Open from <ToolboxPath kind="window" steps={["Toolbox", "Info"]} /> or <ToolboxPath kind="command" steps={["/show info"]} />. Per-window options live under <ToolboxPath steps={["Settings", "Info"]} />.
