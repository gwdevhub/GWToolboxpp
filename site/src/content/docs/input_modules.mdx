...
GWToolbox++ includes several modules that enhance and fix various input-related aspects of Guild Wars. These modules improve the user experience by addressing common issues and adding useful features. Each one is configured in its own section of the settings panel.

## Mouse Fix

The Mouse Fix module addresses issues related to cursor movement and camera control in Guild Wars.

<ToolboxPath steps={['Settings', 'Mouse Settings']} />
...
<ToolboxPath steps={['Settings', 'Keyboard Layout Fix']} />
