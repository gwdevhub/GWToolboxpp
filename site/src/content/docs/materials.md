...
### Gold Management
Enable "Automatically manage gold" in the [Settings](/docs/settings/) window to have GWToolbox++ automatically withdraw or deposit gold as needed during transactions.
