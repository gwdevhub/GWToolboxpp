...
<figure>
<img src="/docs-images/28233538-62518442-68ac-11e7-80f7-c1b68b0c81b3.webp"/>
<figcaption>Materials Window</figcaption>
</figure>

Open from <ToolboxPath kind="window" steps={["Toolbox", "Materials"]} /> or <ToolboxPath kind="command" steps={["/show materials"]} />. Per-window options live under <ToolboxPath steps={["Settings", "Materials"]} />.
