...
All of these settings can be adjusted in [Settings](/docs/settings/) or in the `GWToolbox.ini` file in the settings folder.
...
Use the [Info](/docs/info/) window to find the co-ordinates and Map ID of where you want the marker to appear.</br>
