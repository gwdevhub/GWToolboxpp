...
## Settings
The Pcons windows is highly customizable in the [Settings](/docs/settings/) window. As well as the usual window options, there are several extra settings to be adjusted:
