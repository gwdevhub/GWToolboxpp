...
Open from <ToolboxPath kind="window" steps={["Toolbox", "Plugins"]} /> or <ToolboxPath kind="command" steps={["/show plugins"]} />. Per-window options live under <ToolboxPath steps={["Settings", "Plugins"]} />.
