...
GWToolbox++ includes enhanced functionality for quests, providing users with improved navigation and information display. Configure all quest-related widgets and modules under <ToolboxPath steps={['Settings', 'Active Quest Info']} /> and <ToolboxPath steps={['Settings', 'Quest Module']} />.
...
<ToolboxPath steps={['Settings', 'Active Quest Info']} />
...
<ToolboxPath steps={['Settings', 'Quest Module']} />
