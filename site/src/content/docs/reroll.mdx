...
Open from <ToolboxPath kind="window" steps={["Toolbox", "Reroll"]} /> or <ToolboxPath kind="command" steps={["/show reroll"]} />. Per-window options live under <ToolboxPath steps={["Settings", "Reroll"]} />.
