...
* **Agent and name tag colours** are configured together under [Agent Appearance](#agent-appearance). Set a row's **Text color** for the in-game name tag; leave it unchecked to retain Guild Wars' colour.
