...
* **Agent and name tag colours** are configured together under [Minimap → Custom Agents](/docs/minimap/#custom-agents). Set a row's **Text color** for the in-game name tag; leave it unchecked to retain Guild Wars' colour. Previously configured name tag colours are migrated to rows there.
