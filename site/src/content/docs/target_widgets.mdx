...
GWToolbox++ provides several widgets that display information about your current target, enhancing your gameplay experience and decision-making. Each one has its own section in the settings panel — see the headings below for the exact path.

## Distance Widget

The Distance Widget shows the distance between you and your current target.

<ToolboxPath steps={['Settings', 'Distance']} />
...
<ToolboxPath steps={['Settings', 'Health']} />
...
Open from <ToolboxPath kind="window" steps={['Toolbox', 'Target Info']} /> or with <ToolboxPath kind="command" steps={['/show targetinfo']} />. Settings live under <ToolboxPath steps={['Settings', 'Target Info']} />.
