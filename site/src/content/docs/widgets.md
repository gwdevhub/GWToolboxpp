...
Unlike [Windows](/docs/windows/), widgets are designed to stay open all the time, as part of your user interface. Mostly widgets are non-interactive, and just display information.

All widgets have options in [Settings](/docs/settings/) to specify the exact co-ordinates of their on-screen position and prevent the widget from being moved around or re-sized.
...
* Checkboxes in the [Info](/docs/info/) window.
* Checkboxes in the right of each header on [Settings](/docs/settings/).
...
## Minimap
The [minimap](/docs/minimap/) is an improved version of the default Guild Wars compass, with such features as targeting, zoom, and accurate pathing maps.

## Damage
The [damage monitor](/docs/damage_monitor/) records how much damage has been dealt by each party member and displays it as a number, as a percentage of the party's total, and as a thick horizontal bar.

## Bonds
The bonds monitor shows which maintained monk enchantments you currently have on the allies in the party window. There is an option in [Settings](/docs/settings/) to only show bonds for party members. The monitor also shows refrains ([Heroic Refrain](https://wiki.guildwars.com/wiki/Heroic_Refrain), [Bladeturn Refrain](https://wiki.guildwars.com/wiki/Bladeturn_Refrain), [Burning Refrain](https://wiki.guildwars.com/wiki/Burning_Refrain), [Hasty Refrain](https://wiki.guildwars.com/wiki/Hasty_Refrain), [Mending Refrain](https://wiki.guildwars.com/wiki/Mending_Refrain)) you have cast on yourself and your heroes. Refrains cast on **other players** cannot be shown: Guild Wars only tells your client about the effects on you and your own heroes, so a refrain you are maintaining on another player will leave its slot on the monitor empty.

The bonds are displayed in the order they appear in your skill bar when entering the zone. There is a button in [Settings](/docs/settings/) to refresh the order if you re-order your skill bar in an explorable area. You can also make them appear in reverse order.
...
You can click on the monitor to cast or dismiss bonds and cast refrains. This can be disabled in [Settings](/docs/settings/).

You can customize the background color of the monitor in [Settings](/docs/settings/). You can also adjust the row height to make it line up better with your party window.
